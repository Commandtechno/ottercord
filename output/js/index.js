...
/** Returns all achievements for the given application. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ function getAchievements(applicationId) { return fetch({ method: "GET", path: "/applications".concat(applicationId).concat("/achievements"), headers: { Authorization: getAuth() } }); }
exports.getAchievements = getAchievements;
/** Returns the given achievement for the given application. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ function getAchievement(applicationId, achievementId) { return fetch({ method: "GET", path: "/applications".concat(applicationId).concat("/achievements").concat(achievementId), headers: { Authorization: getAuth() } }); }
exports.getAchievement = getAchievement;
/** Creates a new achievement for your application. Applications can have a maximum of 1000 achievements. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ function createAchievement(applicationId) { return fetch({ method: "POST", path: "/applications".concat(applicationId).concat("/achievements"), headers: { Authorization: getAuth() } }); }
exports.createAchievement = createAchievement;
/** Updates the achievement for \_\_ALL USERS\_\_. This is NOT to update a single user's achievement progress; this is to edit the UserAchievement itself. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ function updateAchievement(applicationId, achievementId) { return fetch({ method: "PATCH", path: "/applications".concat(applicationId).concat("/achievements").concat(achievementId), headers: { Authorization: getAuth() } }); }
exports.updateAchievement = updateAchievement;
/** Deletes the given achievement from your application. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ function deleteAchievement(applicationId, achievementId) { return fetch({ method: "DELETE", path: "/applications".concat(applicationId).concat("/achievements").concat(achievementId), headers: { Authorization: getAuth() } }); }
exports.deleteAchievement = deleteAchievement;
/** Updates the UserAchievement record for a given user. Use this endpoint to update secure achievement progress for users. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ function updateUserAchievement(applicationId, achievementId) { return fetch({ method: "PUT", path: "/applications".concat(applicationId).concat("/achievements").concat(achievementId), headers: { Authorization: getAuth() } }); }
exports.updateUserAchievement = updateUserAchievement;
/** Returns a list of achievements for the user whose token you're making the request with. This endpoint will NOT accept the Bearer token for your application generated via the Client Crendentials Grant. You will need the user's bearer token, gotten via either the Authorization Code OAuth2 Grant or via the SDK with GetOAuth2Token. This endpoint has a rate limit of 2 requests per 5 seconds per application per user.*/ function getUserAchievements(applicationId) { return fetch({ method: "GET", path: "/users".concat("/@me").concat("/applications").concat(applicationId).concat("/achievements"), headers: { Authorization: getAuth() } }); }
exports.getUserAchievements = getUserAchievements;
/** Creates a new lobby. Returns an object similar to the SDK Lobby struct, documented below.*/ function createLobby() { return fetch({ method: "POST", path: "/lobbies", headers: { Authorization: getAuth() } }); }
exports.createLobby = createLobby;
/** Updates a lobby.*/ function updateLobby(lobbyId) { return fetch({ method: "PATCH", path: "/lobbies".concat(lobbyId), headers: { Authorization: getAuth() } }); }
exports.updateLobby = updateLobby;
/** Deletes a lobby.*/ function deleteLobby(lobbyId) { return fetch({ method: "DELETE", path: "/lobbies".concat(lobbyId), headers: { Authorization: getAuth() } }); }
exports.deleteLobby = deleteLobby;
/** PATCH https://discord.com/api/v6/lobbies/<lobby_id>/members/<user_id>*/ function updateLobbyMember(lobbyId, userId) { return fetch({ method: "PATCH", path: "/lobbies".concat(lobbyId).concat("/members").concat(userId), headers: { Authorization: getAuth() } }); }
exports.updateLobbyMember = updateLobbyMember;
/** Creates a lobby search for matchmaking around given criteria.*/ function createLobbySearch() { return fetch({ method: "POST", path: "/lobbies".concat("/search"), headers: { Authorization: getAuth() } }); }
exports.createLobbySearch = createLobbySearch;
/** Sends a message to the lobby, fanning it out to other lobby members.*/ function sendLobbyData(lobbyId) { return fetch({ method: "POST", path: "/lobbies".concat(lobbyId).concat("/send"), headers: { Authorization: getAuth() } }); }
exports.sendLobbyData = sendLobbyData;
/** Gets entitlements for a given user. You can use this on your game backend to check entitlements of an arbitrary user, or perhaps in an administrative panel for your support team.*/ function getEntitlements(applicationId) { return fetch({ method: "GET", path: "/applications".concat(applicationId).concat("/entitlements"), headers: { Authorization: getAuth() } }); }
exports.getEntitlements = getEntitlements;
/** Fetch an entitlement by its ID. This may be useful in confirming that a user has a given entitlement that another call or the SDK says they do.*/ function getEntitlement(applicationId, entitlementId) { return fetch({ method: "GET", path: "/applications".concat(applicationId).concat("/entitlements").concat(entitlementId), headers: { Authorization: getAuth() } }); }
exports.getEntitlement = getEntitlement;
/** Get all SKUs for an application.*/ function getSkus(applicationId) { return fetch({ method: "GET", path: "/applications".concat(applicationId).concat("/skus"), headers: { Authorization: getAuth() } }); }
exports.getSkus = getSkus;
/** Marks a given entitlement for the user as consumed, meaning it will no longer be returned in an entitlements check. Ensure the user was granted whatever items the entitlement was for before consuming it!*/ function consumeSku(applicationId, entitlementId) { return fetch({ method: "POST", path: "/applications".concat(applicationId).concat("/entitlements").concat(entitlementId).concat("/consume"), headers: { Authorization: getAuth() } }); }
exports.consumeSku = consumeSku;
/** Deletes a test entitlement for an application. You can only delete entitlements that were "purchased" in developer test mode; these are entitlements of type == TestModePurchase. You cannot use this route to delete arbitrary entitlements that users actually purchased.*/ function deleteTestEntitlement(applicationId, entitlementId) { return fetch({ method: "DELETE", path: "/applications".concat(applicationId).concat("/entitlements").concat(entitlementId), headers: { Authorization: getAuth() } }); }
exports.deleteTestEntitlement = deleteTestEntitlement;
/** Creates a discount for the given user on their next purchase of the given SKU. You should call this endpoint from your backend server just before calling StartPurchase for the SKU you wish to discount. The user will then see a discounted price for that SKU at time of payment. The discount is automatically consumed after successful purchase or if the TTL expires.*/ function createPurchaseDiscount(skuId, userId) { return fetch({ method: "PUT", path: "/store".concat("/skus").concat(skuId).concat("/discounts").concat(userId), headers: { Authorization: getAuth() } }); }
exports.createPurchaseDiscount = createPurchaseDiscount;
/** Deletes the currently active discount on the given SKU for the given user. You do not need to call this after a user has made a discounted purchase; successful discounted purchases will automatically remove the discount for that user for subsequent purchases.*/ function deletePurchaseDiscount(skuId, userId) { return fetch({ method: "DELETE", path: "/store".concat("/skus").concat(skuId).concat("/discounts").concat(userId), headers: { Authorization: getAuth() } }); }
exports.deletePurchaseDiscount = deletePurchaseDiscount;
/** Fetch all of the global commands for your application. Returns an array of application command objects.*/ function getGlobalApplicationCommands(applicationId) { return fetch({ method: "GET", path: "/applications".concat(applicationId).concat("/commands"), headers: { Authorization: getAuth() } }); }
exports.getGlobalApplicationCommands = getGlobalApplicationCommands;
/** Create a new global command. New global commands will be available in all guilds after 1 hour. Returns 201 and an application command object.*/ function createGlobalApplicationCommand(applicationId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/applications".concat(applicationId).concat("/commands"), headers: { Authorization: getAuth() } }); }
exports.createGlobalApplicationCommand = createGlobalApplicationCommand;
/** Fetch a global command for your application. Returns an application command object.*/ function getGlobalApplicationCommand(applicationId, commandId) { return fetch({ method: "GET", path: "/applications".concat(applicationId).concat("/commands").concat(commandId), headers: { Authorization: getAuth() } }); }
exports.getGlobalApplicationCommand = getGlobalApplicationCommand;
/** Edit a global command. Updates will be available in all guilds after 1 hour. Returns 200 and an application command object. All fields are optional, but any fields provided will entirely overwrite the existing values of those fields.*/ function editGlobalApplicationCommand(applicationId, commandId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/applications".concat(applicationId).concat("/commands").concat(commandId), headers: { Authorization: getAuth() } }); }
exports.editGlobalApplicationCommand = editGlobalApplicationCommand;
/** Deletes a global command. Returns 204 No Content on success.*/ function deleteGlobalApplicationCommand(applicationId, commandId) { return fetch({ method: "DELETE", path: "/applications".concat(applicationId).concat("/commands").concat(commandId), headers: { Authorization: getAuth() } }); }
exports.deleteGlobalApplicationCommand = deleteGlobalApplicationCommand;
/** Takes a list of application commands, overwriting the existing global command list for this application. Updates will be available in all guilds after 1 hour. Returns 200 and a list of application command objects. Commands that do not already exist will count toward daily application command create limits.*/ function bulkOverwriteGlobalApplicationCommands(applicationId) { return fetch({ method: "PUT", path: "/applications".concat(applicationId).concat("/commands"), headers: { Authorization: getAuth() } }); }
exports.bulkOverwriteGlobalApplicationCommands = bulkOverwriteGlobalApplicationCommands;
/** Fetch all of the guild commands for your application for a specific guild. Returns an array of application command objects.*/ function getGuildApplicationCommands(applicationId, guildId) { return fetch({ method: "GET", path: "/applications".concat(applicationId).concat("/guilds").concat(guildId).concat("/commands"), headers: { Authorization: getAuth() } }); }
exports.getGuildApplicationCommands = getGuildApplicationCommands;
/** Create a new guild command. New guild commands will be available in the guild immediately. Returns 201 and an application command object. If the command did not already exist, it will count toward daily application command create limits.*/ function createGuildApplicationCommand(applicationId, guildId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/applications".concat(applicationId).concat("/guilds").concat(guildId).concat("/commands"), headers: { Authorization: getAuth() } }); }
exports.createGuildApplicationCommand = createGuildApplicationCommand;
/** Fetch a guild command for your application. Returns an application command object.*/ function getGuildApplicationCommand(applicationId, guildId, commandId) { return fetch({ method: "GET", path: "/applications".concat(applicationId).concat("/guilds").concat(guildId).concat("/commands").concat(commandId), headers: { Authorization: getAuth() } }); }
exports.getGuildApplicationCommand = getGuildApplicationCommand;
/** Edit a guild command. Updates for guild commands will be available immediately. Returns 200 and an application command object. All fields are optional, but any fields provided will entirely overwrite the existing values of those fields.*/ function editGuildApplicationCommand(applicationId, guildId, commandId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/applications".concat(applicationId).concat("/guilds").concat(guildId).concat("/commands").concat(commandId), headers: { Authorization: getAuth() } }); }
exports.editGuildApplicationCommand = editGuildApplicationCommand;
/** Delete a guild command. Returns 204 No Content on success.*/ function deleteGuildApplicationCommand(applicationId, guildId, commandId) { return fetch({ method: "DELETE", path: "/applications".concat(applicationId).concat("/guilds").concat(guildId).concat("/commands").concat(commandId), headers: { Authorization: getAuth() } }); }
exports.deleteGuildApplicationCommand = deleteGuildApplicationCommand;
/** Takes a list of application commands, overwriting the existing command list for this application for the targeted guild. Returns 200 and a list of application command objects.*/ function bulkOverwriteGuildApplicationCommands(applicationId, guildId) { return fetch({ method: "PUT", path: "/applications".concat(applicationId).concat("/guilds").concat(guildId).concat("/commands"), headers: { Authorization: getAuth() } }); }
exports.bulkOverwriteGuildApplicationCommands = bulkOverwriteGuildApplicationCommands;
/** Fetches command permissions for all commands for your application in a guild. Returns an array of guild application command permissions objects.*/ function getGuildApplicationCommandPermissions(applicationId, guildId) { return fetch({ method: "GET", path: "/applications".concat(applicationId).concat("/guilds").concat(guildId).concat("/commands").concat("/permissions"), headers: { Authorization: getAuth() } }); }
exports.getGuildApplicationCommandPermissions = getGuildApplicationCommandPermissions;
/** Fetches command permissions for a specific command for your application in a guild. Returns a guild application command permissions object.*/ function getApplicationCommandPermissions(applicationId, guildId, commandId) { return fetch({ method: "GET", path: "/applications".concat(applicationId).concat("/guilds").concat(guildId).concat("/commands").concat(commandId).concat("/permissions"), headers: { Authorization: getAuth() } }); }
exports.getApplicationCommandPermissions = getApplicationCommandPermissions;
/** Edits command permissions for a specific command for your application in a guild. You can only add up to 10 permission overwrites for a command. Returns a GuildApplicationCommandPermissions object.*/ function editApplicationCommandPermissions(applicationId, guildId, commandId, body) { return fetch({ body: JSON.stringify(body), method: "PUT", path: "/applications".concat(applicationId).concat("/guilds").concat(guildId).concat("/commands").concat(commandId).concat("/permissions"), headers: { Authorization: getAuth() } }); }
exports.editApplicationCommandPermissions = editApplicationCommandPermissions;
/** Batch edits permissions for all commands in a guild. Takes an array of partial guild application command permissions objects including id and permissions.*/ function batchEditApplicationCommandPermissions(applicationId, guildId) { return fetch({ method: "PUT", path: "/applications".concat(applicationId).concat("/guilds").concat(guildId).concat("/commands").concat("/permissions"), headers: { Authorization: getAuth() } }); }
exports.batchEditApplicationCommandPermissions = batchEditApplicationCommandPermissions;
/** Create a response to an Interaction from the gateway. Body is an interaction response. Returns 204 No Content.*/ function createInteractionResponse(interactionId, interactionToken) { return fetch({ method: "POST", path: "/interactions".concat(interactionId).concat(interactionToken).concat("/callback"), headers: { Authorization: getAuth() } }); }
exports.createInteractionResponse = createInteractionResponse;
/** Returns the initial Interaction response. Functions the same as Get Webhook Message.*/ function getOriginalInteractionResponse(applicationId, interactionToken) { return fetch({ method: "GET", path: "/webhooks".concat(applicationId).concat(interactionToken).concat("/messages").concat("/@original"), headers: { Authorization: getAuth() } }); }
exports.getOriginalInteractionResponse = getOriginalInteractionResponse;
/** Edits the initial Interaction response. Functions the same as Edit Webhook Message.*/ function editOriginalInteractionResponse(applicationId, interactionToken, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/webhooks".concat(applicationId).concat(interactionToken).concat("/messages").concat("/@original"), headers: { Authorization: getAuth() } }); }
exports.editOriginalInteractionResponse = editOriginalInteractionResponse;
/** Deletes the initial Interaction response. Returns 204 No Content on success. Does not support ephemeral followups.*/ function deleteOriginalInteractionResponse(applicationId, interactionToken) { return fetch({ method: "DELETE", path: "/webhooks".concat(applicationId).concat(interactionToken).concat("/messages").concat("/@original"), headers: { Authorization: getAuth() } }); }
exports.deleteOriginalInteractionResponse = deleteOriginalInteractionResponse;
/** Create a followup message for an Interaction. Functions the same as Execute Webhook, but wait is always true. The thread_id, avatar_url, and username parameters are not supported when using this endpoint for interaction followups.*/ function createFollowupMessage(applicationId, interactionToken, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/webhooks".concat(applicationId).concat(interactionToken), headers: { Authorization: getAuth() } }); }
exports.createFollowupMessage = createFollowupMessage;
/** Returns a followup message for an Interaction. Functions the same as Get Webhook Message.*/ function getFollowupMessage(applicationId, interactionToken, messageId) { return fetch({ method: "GET", path: "/webhooks".concat(applicationId).concat(interactionToken).concat("/messages").concat(messageId), headers: { Authorization: getAuth() } }); }
exports.getFollowupMessage = getFollowupMessage;
/** Edits a followup message for an Interaction. Functions the same as Edit Webhook Message.*/ function editFollowupMessage(applicationId, interactionToken, messageId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/webhooks".concat(applicationId).concat(interactionToken).concat("/messages").concat(messageId), headers: { Authorization: getAuth() } }); }
exports.editFollowupMessage = editFollowupMessage;
/** Deletes a followup message for an Interaction. Returns 204 No Content on success. Does not support ephemeral followups.*/ function deleteFollowupMessage(applicationId, interactionToken, messageId) { return fetch({ method: "DELETE", path: "/webhooks".concat(applicationId).concat(interactionToken).concat("/messages").concat(messageId), headers: { Authorization: getAuth() } }); }
exports.deleteFollowupMessage = deleteFollowupMessage;
/** Returns an audit log object for the guild. Requires the 'VIEW_AUDIT_LOG' permission.*/ function getGuildAuditLog(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/audit-logs"), headers: { Authorization: getAuth() } }); }
exports.getGuildAuditLog = getGuildAuditLog;
/** Get a channel by ID. Returns a channel object. If the channel is a thread, a thread member object is included in the returned result.*/ function getChannel(channelId) { return fetch({ method: "GET", path: "/channels".concat(channelId), headers: { Authorization: getAuth() } }); }
exports.getChannel = getChannel;
/** Update a channel's settings. Returns a channel on success, and a 400 BAD REQUEST on invalid parameters. All JSON parameters are optional.*/ function modifyChannel(channelId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/channels".concat(channelId), headers: { Authorization: getAuth() } }); }
exports.modifyChannel = modifyChannel;
/** Delete a channel, or close a private message. Requires the MANAGE_CHANNELS permission for the guild, or MANAGE_THREADS if the channel is a thread. Deleting a category does not delete its child channels; they will have their parent_id removed and a Channel Update Gateway event will fire for each of them. Returns a channel object on success. Fires a Channel Delete Gateway event (or Thread Delete if the channel was a thread).*/ function deleteCloseChannel(channelId) { return fetch({ method: "DELETE", path: "/channels".concat(channelId), headers: { Authorization: getAuth() } }); }
exports.deleteCloseChannel = deleteCloseChannel;
/** Returns the messages for a channel. If operating on a guild channel, this endpoint requires the VIEW_CHANNEL permission to be present on the current user. If the current user is missing the 'READ_MESSAGE_HISTORY' permission in the channel then this will return no messages (since they cannot read the message history). Returns an array of message objects on success.*/ function getChannelMessages(channelId) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/messages"), headers: { Authorization: getAuth() } }); }
exports.getChannelMessages = getChannelMessages;
/** Returns a specific message in the channel. If operating on a guild channel, this endpoint requires the 'READ_MESSAGE_HISTORY' permission to be present on the current user. Returns a message object on success.*/ function getChannelMessage(channelId, messageId) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/messages").concat(messageId), headers: { Authorization: getAuth() } }); }
exports.getChannelMessage = getChannelMessage;
/** Post a message to a guild text or DM channel. Returns a message object. Fires a Message Create Gateway event. See message formatting for more information on how to properly format messages.*/ function createMessage(channelId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/channels".concat(channelId).concat("/messages"), headers: { Authorization: getAuth() } }); }
exports.createMessage = createMessage;
/** Crosspost a message in a News Channel to following channels. This endpoint requires the 'SEND_MESSAGES' permission, if the current user sent the message, or additionally the 'MANAGE_MESSAGES' permission, for all other messages, to be present for the current user.*/ function crosspostMessage(channelId, messageId) { return fetch({ method: "POST", path: "/channels".concat(channelId).concat("/messages").concat(messageId).concat("/crosspost"), headers: { Authorization: getAuth() } }); }
exports.crosspostMessage = crosspostMessage;
/** Create a reaction for the message. This endpoint requires the 'READ_MESSAGE_HISTORY' permission to be present on the current user. Additionally, if nobody else has reacted to the message using this emoji, this endpoint requires the 'ADD_REACTIONS' permission to be present on the current user. Returns a 204 empty response on success. The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id.*/ function createReaction(channelId, messageId, emoji) { return fetch({ method: "PUT", path: "/channels".concat(channelId).concat("/messages").concat(messageId).concat("/reactions").concat(emoji).concat("/@me"), headers: { Authorization: getAuth() } }); }
exports.createReaction = createReaction;
/** Delete a reaction the current user has made for the message. Returns a 204 empty response on success. The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id.*/ function deleteOwnReaction(channelId, messageId, emoji) { return fetch({ method: "DELETE", path: "/channels".concat(channelId).concat("/messages").concat(messageId).concat("/reactions").concat(emoji).concat("/@me"), headers: { Authorization: getAuth() } }); }
exports.deleteOwnReaction = deleteOwnReaction;
/** Deletes another user's reaction. This endpoint requires the 'MANAGE_MESSAGES' permission to be present on the current user. Returns a 204 empty response on success. The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id.*/ function deleteUserReaction(channelId, messageId, emoji, userId) { return fetch({ method: "DELETE", path: "/channels".concat(channelId).concat("/messages").concat(messageId).concat("/reactions").concat(emoji).concat(userId), headers: { Authorization: getAuth() } }); }
exports.deleteUserReaction = deleteUserReaction;
/** Get a list of users that reacted with this emoji. Returns an array of user objects on success. The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id.*/ function getReactions(channelId, messageId, emoji) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/messages").concat(messageId).concat("/reactions").concat(emoji), headers: { Authorization: getAuth() } }); }
exports.getReactions = getReactions;
/** Deletes all reactions on a message. This endpoint requires the 'MANAGE_MESSAGES' permission to be present on the current user. Fires a Message Reaction Remove All Gateway event.*/ function deleteAllReactions(channelId, messageId) { return fetch({ method: "DELETE", path: "/channels".concat(channelId).concat("/messages").concat(messageId).concat("/reactions"), headers: { Authorization: getAuth() } }); }
exports.deleteAllReactions = deleteAllReactions;
/** Deletes all the reactions for a given emoji on a message. This endpoint requires the MANAGE_MESSAGES permission to be present on the current user. Fires a Message Reaction Remove Emoji Gateway event. The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id.*/ function deleteAllReactionsForEmoji(channelId, messageId, emoji) { return fetch({ method: "DELETE", path: "/channels".concat(channelId).concat("/messages").concat(messageId).concat("/reactions").concat(emoji), headers: { Authorization: getAuth() } }); }
exports.deleteAllReactionsForEmoji = deleteAllReactionsForEmoji;
/** Edit a previously sent message. The fields content, embeds, and flags can be edited by the original message author. Other users can only edit flags and only if they have the MANAGE_MESSAGES permission in the corresponding channel. When specifying flags, ensure to include all previously set flags/bits in addition to ones that you are modifying. Only flags documented in the table below may be modified by users (unsupported flag changes are currently ignored without error).*/ function editMessage(channelId, messageId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/channels".concat(channelId).concat("/messages").concat(messageId), headers: { Authorization: getAuth() } }); }
exports.editMessage = editMessage;
/** Delete a message. If operating on a guild channel and trying to delete a message that was not sent by the current user, this endpoint requires the MANAGE_MESSAGES permission. Returns a 204 empty response on success. Fires a Message Delete Gateway event.*/ function deleteMessage(channelId, messageId) { return fetch({ method: "DELETE", path: "/channels".concat(channelId).concat("/messages").concat(messageId), headers: { Authorization: getAuth() } }); }
exports.deleteMessage = deleteMessage;
/** Delete multiple messages in a single request. This endpoint can only be used on guild channels and requires the MANAGE_MESSAGES permission. Returns a 204 empty response on success. Fires a Message Delete Bulk Gateway event.*/ function bulkDeleteMessages(channelId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/channels".concat(channelId).concat("/messages").concat("/bulk-delete"), headers: { Authorization: getAuth() } }); }
exports.bulkDeleteMessages = bulkDeleteMessages;
/** Edit the channel permission overwrites for a user or role in a channel. Only usable for guild channels. Requires the MANAGE_ROLES permission. Only permissions your bot has in the guild or parent channel (if applicable) can be allowed/denied (unless your bot has a MANAGE_ROLES overwrite in the channel). Returns a 204 empty response on success. For more information about permissions, see permissions.*/ function editChannelPermissions(channelId, overwriteId, body) { return fetch({ body: JSON.stringify(body), method: "PUT", path: "/channels".concat(channelId).concat("/permissions").concat(overwriteId), headers: { Authorization: getAuth() } }); }
exports.editChannelPermissions = editChannelPermissions;
/** Returns a list of invite objects (with invite metadata) for the channel. Only usable for guild channels. Requires the MANAGE_CHANNELS permission.*/ function getChannelInvites(channelId) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/invites"), headers: { Authorization: getAuth() } }); }
exports.getChannelInvites = getChannelInvites;
/** Create a new invite object for the channel. Only usable for guild channels. Requires the CREATE_INSTANT_INVITE permission. All JSON parameters for this route are optional, however the request body is not. If you are not sending any fields, you still have to send an empty JSON object ({}). Returns an invite object. Fires an Invite Create Gateway event.*/ function createChannelInvite(channelId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/channels".concat(channelId).concat("/invites"), headers: { Authorization: getAuth() } }); }
exports.createChannelInvite = createChannelInvite;
/** Delete a channel permission overwrite for a user or role in a channel. Only usable for guild channels. Requires the MANAGE_ROLES permission. Returns a 204 empty response on success. For more information about permissions, see permissions*/ function deleteChannelPermission(channelId, overwriteId) { return fetch({ method: "DELETE", path: "/channels".concat(channelId).concat("/permissions").concat(overwriteId), headers: { Authorization: getAuth() } }); }
exports.deleteChannelPermission = deleteChannelPermission;
/** Follow a News Channel to send messages to a target channel. Requires the MANAGE_WEBHOOKS permission in the target channel. Returns a followed channel object.*/ function followNewsChannel(channelId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/channels".concat(channelId).concat("/followers"), headers: { Authorization: getAuth() } }); }
exports.followNewsChannel = followNewsChannel;
/** Post a typing indicator for the specified channel. Generally bots should not implement this route. However, if a bot is responding to a command and expects the computation to take a few seconds, this endpoint may be called to let the user know that the bot is processing their message. Returns a 204 empty response on success. Fires a Typing Start Gateway event.*/ function triggerTypingIndicator(channelId) { return fetch({ method: "POST", path: "/channels".concat(channelId).concat("/typing"), headers: { Authorization: getAuth() } }); }
exports.triggerTypingIndicator = triggerTypingIndicator;
/** Returns all pinned messages in the channel as an array of message objects.*/ function getPinnedMessages(channelId) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/pins"), headers: { Authorization: getAuth() } }); }
exports.getPinnedMessages = getPinnedMessages;
/** Pin a message in a channel. Requires the MANAGE_MESSAGES permission. Returns a 204 empty response on success.*/ function pinMessage(channelId, messageId) { return fetch({ method: "PUT", path: "/channels".concat(channelId).concat("/pins").concat(messageId), headers: { Authorization: getAuth() } }); }
exports.pinMessage = pinMessage;
/** Unpin a message in a channel. Requires the MANAGE_MESSAGES permission. Returns a 204 empty response on success.*/ function unpinMessage(channelId, messageId) { return fetch({ method: "DELETE", path: "/channels".concat(channelId).concat("/pins").concat(messageId), headers: { Authorization: getAuth() } }); }
exports.unpinMessage = unpinMessage;
/** Adds a recipient to a Group DM using their access token.*/ function groupDmAddRecipient(channelId, userId, body) { return fetch({ body: JSON.stringify(body), method: "PUT", path: "/channels".concat(channelId).concat("/recipients").concat(userId), headers: { Authorization: getAuth() } }); }
exports.groupDmAddRecipient = groupDmAddRecipient;
/** Removes a recipient from a Group DM.*/ function groupDmRemoveRecipient(channelId, userId) { return fetch({ method: "DELETE", path: "/channels".concat(channelId).concat("/recipients").concat(userId), headers: { Authorization: getAuth() } }); }
exports.groupDmRemoveRecipient = groupDmRemoveRecipient;
/** Creates a new thread from an existing message. Returns a channel on success, and a 400 BAD REQUEST on invalid parameters. Fires a Thread Create Gateway event.*/ function startThreadWithMessage(channelId, messageId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/channels".concat(channelId).concat("/messages").concat(messageId).concat("/threads"), headers: { Authorization: getAuth() } }); }
exports.startThreadWithMessage = startThreadWithMessage;
/** Creates a new thread that is not connected to an existing message. The created thread defaults to a GUILD_PRIVATE_THREAD*. Returns a channel on success, and a 400 BAD REQUEST on invalid parameters. Fires a Thread Create Gateway event.*/ function startThreadWithoutMessage(channelId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/channels".concat(channelId).concat("/threads"), headers: { Authorization: getAuth() } }); }
exports.startThreadWithoutMessage = startThreadWithoutMessage;
/** Adds the current user to a thread. Also requires the thread is not archived. Returns a 204 empty response on success. Fires a Thread Members Update Gateway event.*/ function joinThread(channelId) { return fetch({ method: "PUT", path: "/channels".concat(channelId).concat("/thread-members").concat("/@me"), headers: { Authorization: getAuth() } }); }
exports.joinThread = joinThread;
/** Adds another member to a thread. Requires the ability to send messages in the thread. Also requires the thread is not archived. Returns a 204 empty response if the member is successfully added or was already a member of the thread. Fires a Thread Members Update Gateway event.*/ function addThreadMember(channelId, userId) { return fetch({ method: "PUT", path: "/channels".concat(channelId).concat("/thread-members").concat(userId), headers: { Authorization: getAuth() } }); }
exports.addThreadMember = addThreadMember;
/** Removes the current user from a thread. Also requires the thread is not archived. Returns a 204 empty response on success. Fires a Thread Members Update Gateway event.*/ function leaveThread(channelId) { return fetch({ method: "DELETE", path: "/channels".concat(channelId).concat("/thread-members").concat("/@me"), headers: { Authorization: getAuth() } }); }
exports.leaveThread = leaveThread;
/** Removes another member from a thread. Requires the MANAGE_THREADS permission, or the creator of the thread if it is a GUILD_PRIVATE_THREAD. Also requires the thread is not archived. Returns a 204 empty response on success. Fires a Thread Members Update Gateway event.*/ function removeThreadMember(channelId, userId) { return fetch({ method: "DELETE", path: "/channels".concat(channelId).concat("/thread-members").concat(userId), headers: { Authorization: getAuth() } }); }
exports.removeThreadMember = removeThreadMember;
/** Returns a thread member object for the specified user if they are a member of the thread, returns a 404 response otherwise.*/ function getThreadMember(channelId, userId) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/thread-members").concat(userId), headers: { Authorization: getAuth() } }); }
exports.getThreadMember = getThreadMember;
/** Returns array of thread members objects that are members of the thread.*/ function listThreadMembers(channelId) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/thread-members"), headers: { Authorization: getAuth() } }); }
exports.listThreadMembers = listThreadMembers;
/** Returns all active threads in the channel, including public and private threads. Threads are ordered by their id, in descending order.*/ function listActiveThreads(channelId) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/threads").concat("/active"), headers: { Authorization: getAuth() } }); }
exports.listActiveThreads = listActiveThreads;
/** Returns archived threads in the channel that are public. When called on a GUILD_TEXT channel, returns threads of type GUILD_PUBLIC_THREAD. When called on a GUILD_NEWS channel returns threads of type GUILD_NEWS_THREAD. Threads are ordered by archive_timestamp, in descending order. Requires the READ_MESSAGE_HISTORY permission.*/ function listPublicArchivedThreads(channelId) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/threads").concat("/archived").concat("/public"), headers: { Authorization: getAuth() } }); }
exports.listPublicArchivedThreads = listPublicArchivedThreads;
/** Returns archived threads in the channel that are of type GUILD_PRIVATE_THREAD. Threads are ordered by archive_timestamp, in descending order. Requires both the READ_MESSAGE_HISTORY and MANAGE_THREADS permissions.*/ function listPrivateArchivedThreads(channelId) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/threads").concat("/archived").concat("/private"), headers: { Authorization: getAuth() } }); }
exports.listPrivateArchivedThreads = listPrivateArchivedThreads;
/** Returns archived threads in the channel that are of type GUILD_PRIVATE_THREAD, and the user has joined. Threads are ordered by their id, in descending order. Requires the READ_MESSAGE_HISTORY permission.*/ function listJoinedPrivateArchivedThreads(channelId) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/users").concat("/@me").concat("/threads").concat("/archived").concat("/private"), headers: { Authorization: getAuth() } }); }
exports.listJoinedPrivateArchivedThreads = listJoinedPrivateArchivedThreads;
/** Returns a list of emoji objects for the given guild.*/ function listGuildEmojis(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/emojis"), headers: { Authorization: getAuth() } }); }
exports.listGuildEmojis = listGuildEmojis;
/** Returns an emoji object for the given guild and emoji IDs.*/ function getGuildEmoji(guildId, emojiId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/emojis").concat(emojiId), headers: { Authorization: getAuth() } }); }
exports.getGuildEmoji = getGuildEmoji;
/** Create a new emoji for the guild. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns the new emoji object on success. Fires a Guild Emojis Update Gateway event.*/ function createGuildEmoji(guildId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/guilds".concat(guildId).concat("/emojis"), headers: { Authorization: getAuth() } }); }
exports.createGuildEmoji = createGuildEmoji;
/** Modify the given emoji. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns the updated emoji object on success. Fires a Guild Emojis Update Gateway event.*/ function modifyGuildEmoji(guildId, emojiId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/emojis").concat(emojiId), headers: { Authorization: getAuth() } }); }
exports.modifyGuildEmoji = modifyGuildEmoji;
/** Delete the given emoji. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns 204 No Content on success. Fires a Guild Emojis Update Gateway event.*/ function deleteGuildEmoji(guildId, emojiId) { return fetch({ method: "DELETE", path: "/guilds".concat(guildId).concat("/emojis").concat(emojiId), headers: { Authorization: getAuth() } }); }
exports.deleteGuildEmoji = deleteGuildEmoji;
/** Create a new guild. Returns a guild object on success. Fires a Guild Create Gateway event.*/ function createGuild(body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/guilds", headers: { Authorization: getAuth() } }); }
exports.createGuild = createGuild;
/** Returns the guild object for the given id. If with_counts is set to true, this endpoint will also return approximate_member_count and approximate_presence_count for the guild.*/ function getGuild(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId), headers: { Authorization: getAuth() } }); }
exports.getGuild = getGuild;
/** Returns the guild preview object for the given id. If the user is not in the guild, then the guild must be lurkable.*/ function getGuildPreview(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/preview"), headers: { Authorization: getAuth() } }); }
exports.getGuildPreview = getGuildPreview;
/** Modify a guild's settings. Requires the MANAGE_GUILD permission. Returns the updated guild object on success. Fires a Guild Update Gateway event.*/ function modifyGuild(guildId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId), headers: { Authorization: getAuth() } }); }
exports.modifyGuild = modifyGuild;
/** Delete a guild permanently. User must be owner. Returns 204 No Content on success. Fires a Guild Delete Gateway event.*/ function deleteGuild(guildId) { return fetch({ method: "DELETE", path: "/guilds".concat(guildId), headers: { Authorization: getAuth() } }); }
exports.deleteGuild = deleteGuild;
/** Returns a list of guild channel objects. Does not include threads.*/ function getGuildChannels(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/channels"), headers: { Authorization: getAuth() } }); }
exports.getGuildChannels = getGuildChannels;
/** Create a new channel object for the guild. Requires the MANAGE_CHANNELS permission. If setting permission overwrites, only permissions your bot has in the guild can be allowed/denied. Setting MANAGE_ROLES permission in channels is only possible for guild administrators. Returns the new channel object on success. Fires a Channel Create Gateway event.*/ function createGuildChannel(guildId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/guilds".concat(guildId).concat("/channels"), headers: { Authorization: getAuth() } }); }
exports.createGuildChannel = createGuildChannel;
/** Modify the positions of a set of channel objects for the guild. Requires MANAGE_CHANNELS permission. Returns a 204 empty response on success. Fires multiple Channel Update Gateway events.*/ function modifyGuildChannelPositions(guildId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/channels"), headers: { Authorization: getAuth() } }); }
exports.modifyGuildChannelPositions = modifyGuildChannelPositions;
/** Returns all active threads in the guild, including public and private threads. Threads are ordered by their id, in descending order.*/ function listActiveThreads_(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/threads").concat("/active"), headers: { Authorization: getAuth() } }); }
exports.listActiveThreads_ = listActiveThreads_;
/** Returns a guild member object for the specified user.*/ function getGuildMember(guildId, userId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/members").concat(userId), headers: { Authorization: getAuth() } }); }
exports.getGuildMember = getGuildMember;
/** Returns a list of guild member objects that are members of the guild.*/ function listGuildMembers(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/members"), headers: { Authorization: getAuth() } }); }
exports.listGuildMembers = listGuildMembers;
/** Returns a list of guild member objects whose username or nickname starts with a provided string.*/ function searchGuildMembers(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/members").concat("/search"), headers: { Authorization: getAuth() } }); }
exports.searchGuildMembers = searchGuildMembers;
/** Adds a user to the guild, provided you have a valid oauth2 access token for the user with the guilds.join scope. Returns a 201 Created with the guild member as the body, or 204 No Content if the user is already a member of the guild. Fires a Guild Member Add Gateway event.*/ function addGuildMember(guildId, userId, body) { return fetch({ body: JSON.stringify(body), method: "PUT", path: "/guilds".concat(guildId).concat("/members").concat(userId), headers: { Authorization: getAuth() } }); }
exports.addGuildMember = addGuildMember;
/** Modify attributes of a guild member. Returns a 200 OK with the guild member as the body. Fires a Guild Member Update Gateway event. If the channel_id is set to null, this will force the target user to be disconnected from voice.*/ function modifyGuildMember(guildId, userId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/members").concat(userId), headers: { Authorization: getAuth() } }); }
exports.modifyGuildMember = modifyGuildMember;
/** Modifies the current member in a guild. Returns a 200 with the updated member object on success. Fires a Guild Member Update Gateway event.*/ function modifyCurrentMember(guildId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/members").concat("/@me"), headers: { Authorization: getAuth() } }); }
exports.modifyCurrentMember = modifyCurrentMember;
/** Modifies the nickname of the current user in a guild. Returns a 200 with the nickname on success. Fires a Guild Member Update Gateway event.*/ function modifyCurrentUserNick(guildId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/members").concat("/@me").concat("/nick"), headers: { Authorization: getAuth() } }); }
exports.modifyCurrentUserNick = modifyCurrentUserNick;
/** Adds a role to a guild member. Requires the MANAGE_ROLES permission. Returns a 204 empty response on success. Fires a Guild Member Update Gateway event.*/ function addGuildMemberRole(guildId, userId, roleId) { return fetch({ method: "PUT", path: "/guilds".concat(guildId).concat("/members").concat(userId).concat("/roles").concat(roleId), headers: { Authorization: getAuth() } }); }
exports.addGuildMemberRole = addGuildMemberRole;
/** Removes a role from a guild member. Requires the MANAGE_ROLES permission. Returns a 204 empty response on success. Fires a Guild Member Update Gateway event.*/ function removeGuildMemberRole(guildId, userId, roleId) { return fetch({ method: "DELETE", path: "/guilds".concat(guildId).concat("/members").concat(userId).concat("/roles").concat(roleId), headers: { Authorization: getAuth() } }); }
exports.removeGuildMemberRole = removeGuildMemberRole;
/** Remove a member from a guild. Requires KICK_MEMBERS permission. Returns a 204 empty response on success. Fires a Guild Member Remove Gateway event.*/ function removeGuildMember(guildId, userId) { return fetch({ method: "DELETE", path: "/guilds".concat(guildId).concat("/members").concat(userId), headers: { Authorization: getAuth() } }); }
exports.removeGuildMember = removeGuildMember;
/** Returns a list of ban objects for the users banned from this guild. Requires the BAN_MEMBERS permission.*/ function getGuildBans(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/bans"), headers: { Authorization: getAuth() } }); }
exports.getGuildBans = getGuildBans;
/** Returns a ban object for the given user or a 404 not found if the ban cannot be found. Requires the BAN_MEMBERS permission.*/ function getGuildBan(guildId, userId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/bans").concat(userId), headers: { Authorization: getAuth() } }); }
exports.getGuildBan = getGuildBan;
/** Create a guild ban, and optionally delete previous messages sent by the banned user. Requires the BAN_MEMBERS permission. Returns a 204 empty response on success. Fires a Guild Ban Add Gateway event.*/ function createGuildBan(guildId, userId, body) { return fetch({ body: JSON.stringify(body), method: "PUT", path: "/guilds".concat(guildId).concat("/bans").concat(userId), headers: { Authorization: getAuth() } }); }
exports.createGuildBan = createGuildBan;
/** Remove the ban for a user. Requires the BAN_MEMBERS permissions. Returns a 204 empty response on success. Fires a Guild Ban Remove Gateway event.*/ function removeGuildBan(guildId, userId) { return fetch({ method: "DELETE", path: "/guilds".concat(guildId).concat("/bans").concat(userId), headers: { Authorization: getAuth() } }); }
exports.removeGuildBan = removeGuildBan;
/** Returns a list of role objects for the guild.*/ function getGuildRoles(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/roles"), headers: { Authorization: getAuth() } }); }
exports.getGuildRoles = getGuildRoles;
/** Create a new role for the guild. Requires the MANAGE_ROLES permission. Returns the new role object on success. Fires a Guild Role Create Gateway event. All JSON params are optional.*/ function createGuildRole(guildId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/guilds".concat(guildId).concat("/roles"), headers: { Authorization: getAuth() } }); }
exports.createGuildRole = createGuildRole;
/** Modify the positions of a set of role objects for the guild. Requires the MANAGE_ROLES permission. Returns a list of all of the guild's role objects on success. Fires multiple Guild Role Update Gateway events.*/ function modifyGuildRolePositions(guildId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/roles"), headers: { Authorization: getAuth() } }); }
exports.modifyGuildRolePositions = modifyGuildRolePositions;
/** Modify a guild role. Requires the MANAGE_ROLES permission. Returns the updated role on success. Fires a Guild Role Update Gateway event.*/ function modifyGuildRole(guildId, roleId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/roles").concat(roleId), headers: { Authorization: getAuth() } }); }
exports.modifyGuildRole = modifyGuildRole;
/** Delete a guild role. Requires the MANAGE_ROLES permission. Returns a 204 empty response on success. Fires a Guild Role Delete Gateway event.*/ function deleteGuildRole(guildId, roleId) { return fetch({ method: "DELETE", path: "/guilds".concat(guildId).concat("/roles").concat(roleId), headers: { Authorization: getAuth() } }); }
exports.deleteGuildRole = deleteGuildRole;
/** Returns an object with one 'pruned' key indicating the number of members that would be removed in a prune operation. Requires the KICK_MEMBERS permission.*/ function getGuildPruneCount(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/prune"), headers: { Authorization: getAuth() } }); }
exports.getGuildPruneCount = getGuildPruneCount;
/** Begin a prune operation. Requires the KICK_MEMBERS permission. Returns an object with one 'pruned' key indicating the number of members that were removed in the prune operation. For large guilds it's recommended to set the compute_prune_count option to false, forcing 'pruned' to null. Fires multiple Guild Member Remove Gateway events.*/ function beginGuildPrune(guildId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/guilds".concat(guildId).concat("/prune"), headers: { Authorization: getAuth() } }); }
exports.beginGuildPrune = beginGuildPrune;
/** Returns a list of voice region objects for the guild. Unlike the similar /voice route, this returns VIP servers when the guild is VIP-enabled.*/ function getGuildVoiceRegions(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/regions"), headers: { Authorization: getAuth() } }); }
exports.getGuildVoiceRegions = getGuildVoiceRegions;
/** Returns a list of invite objects (with invite metadata) for the guild. Requires the MANAGE_GUILD permission.*/ function getGuildInvites(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/invites"), headers: { Authorization: getAuth() } }); }
exports.getGuildInvites = getGuildInvites;
/** Returns a list of integration objects for the guild. Requires the MANAGE_GUILD permission.*/ function getGuildIntegrations(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/integrations"), headers: { Authorization: getAuth() } }); }
exports.getGuildIntegrations = getGuildIntegrations;
/** Delete the attached integration object for the guild. Deletes any associated webhooks and kicks the associated bot if there is one. Requires the MANAGE_GUILD permission. Returns a 204 empty response on success. Fires a Guild Integrations Update Gateway event.*/ function deleteGuildIntegration(guildId, integrationId) { return fetch({ method: "DELETE", path: "/guilds".concat(guildId).concat("/integrations").concat(integrationId), headers: { Authorization: getAuth() } }); }
exports.deleteGuildIntegration = deleteGuildIntegration;
/** Returns a guild widget settings object. Requires the MANAGE_GUILD permission.*/ function getGuildWidgetSettings(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/widget"), headers: { Authorization: getAuth() } }); }
exports.getGuildWidgetSettings = getGuildWidgetSettings;
/** Modify a guild widget settings object for the guild. All attributes may be passed in with JSON and modified. Requires the MANAGE_GUILD permission. Returns the updated guild widget object.*/ function modifyGuildWidget(guildId) { return fetch({ method: "PATCH", path: "/guilds".concat(guildId).concat("/widget"), headers: { Authorization: getAuth() } }); }
exports.modifyGuildWidget = modifyGuildWidget;
/** Returns the widget for the guild.*/ function getGuildWidget(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/widget.json"), headers: { Authorization: getAuth() } }); }
exports.getGuildWidget = getGuildWidget;
/** Returns a partial invite object for guilds with that feature enabled. Requires the MANAGE_GUILD permission. code will be null if a vanity url for the guild is not set.*/ function getGuildVanityUrl(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/vanity-url"), headers: { Authorization: getAuth() } }); }
exports.getGuildVanityUrl = getGuildVanityUrl;
/** Returns a PNG image widget for the guild. Requires no permissions or authentication.*/ function getGuildWidgetImage(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/widget.png"), headers: { Authorization: getAuth() } }); }
exports.getGuildWidgetImage = getGuildWidgetImage;
/** Returns the Welcome Screen object for the guild. If the welcome screen is not enabled, the MANAGE_GUILD permission is required.*/ function getGuildWelcomeScreen(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/welcome-screen"), headers: { Authorization: getAuth() } }); }
exports.getGuildWelcomeScreen = getGuildWelcomeScreen;
/** Modify the guild's Welcome Screen. Requires the MANAGE_GUILD permission. Returns the updated Welcome Screen object.*/ function modifyGuildWelcomeScreen(guildId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/welcome-screen"), headers: { Authorization: getAuth() } }); }
exports.modifyGuildWelcomeScreen = modifyGuildWelcomeScreen;
/** Updates the current user's voice state. Returns 204 No Content on success.*/ function modifyCurrentUserVoiceState(guildId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/voice-states").concat("/@me"), headers: { Authorization: getAuth() } }); }
exports.modifyCurrentUserVoiceState = modifyCurrentUserVoiceState;
/** Updates another user's voice state.*/ function modifyUserVoiceState(guildId, userId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/voice-states").concat(userId), headers: { Authorization: getAuth() } }); }
exports.modifyUserVoiceState = modifyUserVoiceState;
/** Returns a list of guild scheduled event objects for the given guild.*/ function listScheduledEventsForGuild(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/scheduled-events"), headers: { Authorization: getAuth() } }); }
exports.listScheduledEventsForGuild = listScheduledEventsForGuild;
/** Create a guild scheduled event in the guild. Returns a guild scheduled event object on success.*/ function createGuildScheduledEvent(guildId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/guilds".concat(guildId).concat("/scheduled-events"), headers: { Authorization: getAuth() } }); }
exports.createGuildScheduledEvent = createGuildScheduledEvent;
/** Get a guild scheduled event. Returns a guild scheduled event object on success.*/ function getGuildScheduledEvent(guildId, guildScheduledEventId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/scheduled-events").concat(guildScheduledEventId), headers: { Authorization: getAuth() } }); }
exports.getGuildScheduledEvent = getGuildScheduledEvent;
/** Modify a guild scheduled event. Returns the modified guild scheduled event object on success.*/ function modifyGuildScheduledEvent(guildId, guildScheduledEventId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/scheduled-events").concat(guildScheduledEventId), headers: { Authorization: getAuth() } }); }
exports.modifyGuildScheduledEvent = modifyGuildScheduledEvent;
/** Delete a guild scheduled event. Returns a 204 on success.*/ function deleteGuildScheduledEvent(guildId, guildScheduledEventId) { return fetch({ method: "DELETE", path: "/guilds".concat(guildId).concat("/scheduled-events").concat(guildScheduledEventId), headers: { Authorization: getAuth() } }); }
exports.deleteGuildScheduledEvent = deleteGuildScheduledEvent;
/** Get a list of guild scheduled event users subscribed to a guild scheduled event. Returns a list of guild scheduled event user objects on success. Guild member data, if it exists, is included if the with_member query parameter is set.*/ function getGuildScheduledEventUsers(guildId, guildScheduledEventId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/scheduled-events").concat(guildScheduledEventId).concat("/users"), headers: { Authorization: getAuth() } }); }
exports.getGuildScheduledEventUsers = getGuildScheduledEventUsers;
/** Returns a guild template object for the given code.*/ function getGuildTemplate(templateCode) { return fetch({ method: "GET", path: "/guilds".concat("/templates").concat(templateCode), headers: { Authorization: getAuth() } }); }
exports.getGuildTemplate = getGuildTemplate;
/** Create a new guild based on a template. Returns a guild object on success. Fires a Guild Create Gateway event.*/ function createGuildFromGuildTemplate(templateCode, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/guilds".concat("/templates").concat(templateCode), headers: { Authorization: getAuth() } }); }
exports.createGuildFromGuildTemplate = createGuildFromGuildTemplate;
/** Returns an array of guild template objects. Requires the MANAGE_GUILD permission.*/ function getGuildTemplates(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/templates"), headers: { Authorization: getAuth() } }); }
exports.getGuildTemplates = getGuildTemplates;
/** Creates a template for the guild. Requires the MANAGE_GUILD permission. Returns the created guild template object on success.*/ function createGuildTemplate(guildId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/guilds".concat(guildId).concat("/templates"), headers: { Authorization: getAuth() } }); }
exports.createGuildTemplate = createGuildTemplate;
/** Syncs the template to the guild's current state. Requires the MANAGE_GUILD permission. Returns the guild template object on success.*/ function syncGuildTemplate(guildId, templateCode) { return fetch({ method: "PUT", path: "/guilds".concat(guildId).concat("/templates").concat(templateCode), headers: { Authorization: getAuth() } }); }
exports.syncGuildTemplate = syncGuildTemplate;
/** Modifies the template's metadata. Requires the MANAGE_GUILD permission. Returns the guild template object on success.*/ function modifyGuildTemplate(guildId, templateCode, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/templates").concat(templateCode), headers: { Authorization: getAuth() } }); }
exports.modifyGuildTemplate = modifyGuildTemplate;
/** Deletes the template. Requires the MANAGE_GUILD permission. Returns the deleted guild template object on success.*/ function deleteGuildTemplate(guildId, templateCode) { return fetch({ method: "DELETE", path: "/guilds".concat(guildId).concat("/templates").concat(templateCode), headers: { Authorization: getAuth() } }); }
exports.deleteGuildTemplate = deleteGuildTemplate;
/** Returns an invite object for the given code.*/ function getInvite(inviteCode) { return fetch({ method: "GET", path: "/invites".concat(inviteCode), headers: { Authorization: getAuth() } }); }
exports.getInvite = getInvite;
/** Delete an invite. Requires the MANAGE_CHANNELS permission on the channel this invite belongs to, or MANAGE_GUILD to remove any invite across the guild. Returns an invite object on success. Fires a Invite Delete Gateway event.*/ function deleteInvite(inviteCode) { return fetch({ method: "DELETE", path: "/invites".concat(inviteCode), headers: { Authorization: getAuth() } }); }
exports.deleteInvite = deleteInvite;
/** Creates a new Stage instance associated to a Stage channel. Returns that Stage instance.*/ function createStageInstance(body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/stage-instances", headers: { Authorization: getAuth() } }); }
exports.createStageInstance = createStageInstance;
/** Gets the stage instance associated with the Stage channel, if it exists.*/ function getStageInstance(channelId) { return fetch({ method: "GET", path: "/stage-instances".concat(channelId), headers: { Authorization: getAuth() } }); }
exports.getStageInstance = getStageInstance;
/** Updates fields of an existing Stage instance. Returns the updated Stage instance.*/ function modifyStageInstance(channelId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/stage-instances".concat(channelId), headers: { Authorization: getAuth() } }); }
exports.modifyStageInstance = modifyStageInstance;
/** Deletes the Stage instance. Returns 204 No Content.*/ function deleteStageInstance(channelId) { return fetch({ method: "DELETE", path: "/stage-instances".concat(channelId), headers: { Authorization: getAuth() } }); }
exports.deleteStageInstance = deleteStageInstance;
/** Returns a sticker object for the given sticker ID.*/ function getSticker(stickerId) { return fetch({ method: "GET", path: "/stickers".concat(stickerId), headers: { Authorization: getAuth() } }); }
exports.getSticker = getSticker;
/** Returns the list of sticker packs available to Nitro subscribers.*/ function listNitroStickerPacks() { return fetch({ method: "GET", path: "/sticker-packs", headers: { Authorization: getAuth() } }); }
exports.listNitroStickerPacks = listNitroStickerPacks;
/** Returns an array of sticker objects for the given guild. Includes user fields if the bot has the MANAGE_EMOJIS_AND_STICKERS permission.*/ function listGuildStickers(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/stickers"), headers: { Authorization: getAuth() } }); }
exports.listGuildStickers = listGuildStickers;
/** Returns a sticker object for the given guild and sticker IDs. Includes the user field if the bot has the MANAGE_EMOJIS_AND_STICKERS permission.*/ function getGuildSticker(guildId, stickerId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/stickers").concat(stickerId), headers: { Authorization: getAuth() } }); }
exports.getGuildSticker = getGuildSticker;
/** Create a new sticker for the guild. Send a multipart/form-data body. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns the new sticker object on success.*/ function createGuildSticker(guildId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/guilds".concat(guildId).concat("/stickers"), headers: { Authorization: getAuth() } }); }
exports.createGuildSticker = createGuildSticker;
/** Modify the given sticker. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns the updated sticker object on success.*/ function modifyGuildSticker(guildId, stickerId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/guilds".concat(guildId).concat("/stickers").concat(stickerId), headers: { Authorization: getAuth() } }); }
exports.modifyGuildSticker = modifyGuildSticker;
/** Delete the given sticker. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns 204 No Content on success.*/ function deleteGuildSticker(guildId, stickerId) { return fetch({ method: "DELETE", path: "/guilds".concat(guildId).concat("/stickers").concat(stickerId), headers: { Authorization: getAuth() } }); }
exports.deleteGuildSticker = deleteGuildSticker;
/** Returns the user object of the requester's account. For OAuth2, this requires the identify scope, which will return the object without an email, and optionally the email scope, which returns the object with an email.*/ function getCurrentUser() { return fetch({ method: "GET", path: "/users".concat("/@me"), headers: { Authorization: getAuth() } }); }
exports.getCurrentUser = getCurrentUser;
/** Returns a user object for a given user ID.*/ function getUser(userId) { return fetch({ method: "GET", path: "/users".concat(userId), headers: { Authorization: getAuth() } }); }
exports.getUser = getUser;
/** Modify the requester's user account settings. Returns a user object on success.*/ function modifyCurrentUser(body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/users".concat("/@me"), headers: { Authorization: getAuth() } }); }
exports.modifyCurrentUser = modifyCurrentUser;
/** Returns a list of partial guild objects the current user is a member of. Requires the guilds OAuth2 scope.*/ function getCurrentUserGuilds() { return fetch({ method: "GET", path: "/users".concat("/@me").concat("/guilds"), headers: { Authorization: getAuth() } }); }
exports.getCurrentUserGuilds = getCurrentUserGuilds;
/** Returns a guild member object for the current user. Requires the guilds.members.read OAuth2 scope.*/ function getCurrentUserGuildMember(guildId) { return fetch({ method: "GET", path: "/users".concat("/@me").concat("/guilds").concat(guildId).concat("/member"), headers: { Authorization: getAuth() } }); }
exports.getCurrentUserGuildMember = getCurrentUserGuildMember;
/** Leave a guild. Returns a 204 empty response on success.*/ function leaveGuild(guildId) { return fetch({ method: "DELETE", path: "/users".concat("/@me").concat("/guilds").concat(guildId), headers: { Authorization: getAuth() } }); }
exports.leaveGuild = leaveGuild;
/** Create a new DM channel with a user. Returns a DM channel object.*/ function createDm(body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/users".concat("/@me").concat("/channels"), headers: { Authorization: getAuth() } }); }
exports.createDm = createDm;
/** Create a new group DM channel with multiple users. Returns a DM channel object. This endpoint was intended to be used with the now-deprecated GameBridge SDK. DMs created with this endpoint will not be shown in the Discord client*/ function createGroupDm(body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/users".concat("/@me").concat("/channels"), headers: { Authorization: getAuth() } }); }
exports.createGroupDm = createGroupDm;
/** Returns a list of connection objects. Requires the connections OAuth2 scope.*/ function getUserConnections() { return fetch({ method: "GET", path: "/users".concat("/@me").concat("/connections"), headers: { Authorization: getAuth() } }); }
exports.getUserConnections = getUserConnections;
/** Returns an array of voice region objects that can be used when setting a voice or stage channel's `rtc_region`.*/ function listVoiceRegions() { return fetch({ method: "GET", path: "/voice".concat("/regions"), headers: { Authorization: getAuth() } }); }
exports.listVoiceRegions = listVoiceRegions;
/** Creates a new webhook and returns a webhook object on success. Requires the MANAGE_WEBHOOKS permission.*/ function createWebhook(channelId, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/channels".concat(channelId).concat("/webhooks"), headers: { Authorization: getAuth() } }); }
exports.createWebhook = createWebhook;
/** Returns a list of channel webhook objects. Requires the MANAGE_WEBHOOKS permission.*/ function getChannelWebhooks(channelId) { return fetch({ method: "GET", path: "/channels".concat(channelId).concat("/webhooks"), headers: { Authorization: getAuth() } }); }
exports.getChannelWebhooks = getChannelWebhooks;
/** Returns a list of guild webhook objects. Requires the MANAGE_WEBHOOKS permission.*/ function getGuildWebhooks(guildId) { return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/webhooks"), headers: { Authorization: getAuth() } }); }
exports.getGuildWebhooks = getGuildWebhooks;
/** Returns the new webhook object for the given id.*/ function getWebhook(webhookId) { return fetch({ method: "GET", path: "/webhooks".concat(webhookId), headers: { Authorization: getAuth() } }); }
exports.getWebhook = getWebhook;
/** Same as above, except this call does not require authentication and returns no user in the webhook object.*/ function getWebhookWithToken(webhookId, webhookToken) { return fetch({ method: "GET", path: "/webhooks".concat(webhookId).concat(webhookToken), headers: { Authorization: getAuth() } }); }
exports.getWebhookWithToken = getWebhookWithToken;
/** Modify a webhook. Requires the MANAGE_WEBHOOKS permission. Returns the updated webhook object on success.*/ function modifyWebhook(webhookId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/webhooks".concat(webhookId), headers: { Authorization: getAuth() } }); }
exports.modifyWebhook = modifyWebhook;
/** Same as above, except this call does not require authentication, does not accept a channel_id parameter in the body, and does not return a user in the webhook object.*/ function modifyWebhookWithToken(webhookId, webhookToken) { return fetch({ method: "PATCH", path: "/webhooks".concat(webhookId).concat(webhookToken), headers: { Authorization: getAuth() } }); }
exports.modifyWebhookWithToken = modifyWebhookWithToken;
/** Delete a webhook permanently. Requires the MANAGE_WEBHOOKS permission. Returns a 204 No Content response on success.*/ function deleteWebhook(webhookId) { return fetch({ method: "DELETE", path: "/webhooks".concat(webhookId), headers: { Authorization: getAuth() } }); }
exports.deleteWebhook = deleteWebhook;
/** Same as above, except this call does not require authentication.*/ function deleteWebhookWithToken(webhookId, webhookToken) { return fetch({ method: "DELETE", path: "/webhooks".concat(webhookId).concat(webhookToken), headers: { Authorization: getAuth() } }); }
exports.deleteWebhookWithToken = deleteWebhookWithToken;
/** Refer to Uploading Files for details on attachments and multipart/form-data requests. Returns a message or 204 No Content depending on the wait query parameter.*/ function executeWebhook(webhookId, webhookToken, body) { return fetch({ body: JSON.stringify(body), method: "POST", path: "/webhooks".concat(webhookId).concat(webhookToken), headers: { Authorization: getAuth() } }); }
exports.executeWebhook = executeWebhook;
/** Refer to Slack's documentation for more information. We do not support Slack's channel, icon_emoji, mrkdwn, or mrkdwn_in properties.*/ function executeSlackCompatibleWebhook(webhookId, webhookToken) { return fetch({ method: "POST", path: "/webhooks".concat(webhookId).concat(webhookToken).concat("/slack"), headers: { Authorization: getAuth() } }); }
exports.executeSlackCompatibleWebhook = executeSlackCompatibleWebhook;
/** Add a new webhook to your GitHub repo (in the repo's settings), and use this endpoint as the "Payload URL." You can choose what events your Discord channel receives by choosing the "Let me select individual events" option and selecting individual events for the new webhook you're configuring.*/ function executeGithubCompatibleWebhook(webhookId, webhookToken) { return fetch({ method: "POST", path: "/webhooks".concat(webhookId).concat(webhookToken).concat("/github"), headers: { Authorization: getAuth() } }); }
exports.executeGithubCompatibleWebhook = executeGithubCompatibleWebhook;
/** Returns a previously-sent webhook message from the same token. Returns a message object on success.*/ function getWebhookMessage(webhookId, webhookToken, messageId) { return fetch({ method: "GET", path: "/webhooks".concat(webhookId).concat(webhookToken).concat("/messages").concat(messageId), headers: { Authorization: getAuth() } }); }
exports.getWebhookMessage = getWebhookMessage;
/** Edits a previously-sent webhook message from the same token. Returns a message object on success.*/ function editWebhookMessage(webhookId, webhookToken, messageId, body) { return fetch({ body: JSON.stringify(body), method: "PATCH", path: "/webhooks".concat(webhookId).concat(webhookToken).concat("/messages").concat(messageId), headers: { Authorization: getAuth() } }); }
exports.editWebhookMessage = editWebhookMessage;
/** Deletes a message that was created by the webhook. Returns a 204 No Content response on success.*/ function deleteWebhookMessage(webhookId, webhookToken, messageId) { return fetch({ method: "DELETE", path: "/webhooks".concat(webhookId).concat(webhookToken).concat("/messages").concat(messageId), headers: { Authorization: getAuth() } }); }
exports.deleteWebhookMessage = deleteWebhookMessage;
/** Returns an object with a single valid WSS URL, which the client can use for Connecting. Clients should cache this value and only call this endpoint to retrieve a new URL if they are unable to properly establish a connection using the cached version of the URL.*/ function getGateway() { return fetch({ method: "GET", path: "/gateway", headers: { Authorization: getAuth() } }); }
exports.getGateway = getGateway;
/** Returns an object based on the information in Get Gateway, plus additional metadata that can help during the operation of large or sharded bots. Unlike the Get Gateway, this route should not be cached for extended periods of time as the value is not guaranteed to be the same per-call, and changes as the bot joins/leaves guilds.*/ function getGatewayBot() { return fetch({ method: "GET", path: "/gateway".concat("/bot"), headers: { Authorization: getAuth() } }); }
exports.getGatewayBot = getGatewayBot;
/** Returns the bot's application object.*/ function getCurrentBotApplicationInformation() { return fetch({ method: "GET", path: "/oauth2".concat("/applications").concat("/@me"), headers: { Authorization: getAuth() } }); }
exports.getCurrentBotApplicationInformation = getCurrentBotApplicationInformation;
/** Returns info about the current authorization. Requires authentication with a bearer token.*/ function getCurrentAuthorizationInformation() { return fetch({ method: "GET", path: "/oauth2".concat("/@me"), headers: { Authorization: getAuth() } }); }

...
export declare const SdkEnvironmentVariables: {
    /** the locally running instance of Discord to connect to; allows you to choose between multiple running clients*/ readonly DiscordInstanceId: "Local Testing";
    /** the connected user's bearer token*/ readonly DiscordAccessToken: "ApplicationManager.GetOAuth2Token";
    /** the language that Discord is in for the connected user*/ readonly DiscordCurrentLocale: "ApplicationManager.GetCurrentLocale";
    /** the branch of the running application that the user has launched*/ readonly DiscordCurrentBranch: "ApplicationManager.GetCurrentBranch";
    /** the path to which Discord will save files if you're using the StorageManager*/ readonly DiscordStoragePath: "StorageManager.GetPath";
};
export declare const ResultEnum: {
    /** everything is good*/ readonly "0": "Ok";
    /** Discord isn't working*/ readonly "1": "ServiceUnavailable";
    /** the SDK version may be outdated*/ readonly "2": "InvalidVersion";
    /** an internal error on transactional operations*/ readonly "3": "LockFailed";
    /** something on our side went wrong*/ readonly "4": "InternalError";
    /** the data you sent didn't match what we expect*/ readonly "5": "InvalidPayload";
    /** that's not a thing you can do*/ readonly "6": "InvalidCommand";
    /** you aren't authorized to do that*/ readonly "7": "InvalidPermissions";
    /** couldn't fetch what you wanted*/ readonly "8": "NotFetched";
    /** what you're looking for doesn't exist*/ readonly "9": "NotFound";
    /** user already has a network connection open on that channel*/ readonly "10": "Conflict";
    /** activity secrets must be unique and not match party id*/ readonly "11": "InvalidSecret";
    /** join request for that user does not exist*/ readonly "12": "InvalidJoinSecret";
    /** you accidentally set an ApplicationId in your UpdateActivity() payload*/ readonly "13": "NoEligibleActivity";
    /** your game invite is no longer valid*/ readonly "14": "InvalidInvite";
    /** the internal auth call failed for the user, and you can't do this*/ readonly "15": "NotAuthenticated";
    /** the user's bearer token is invalid*/ readonly "16": "InvalidAccessToken";
    /** access token belongs to another application*/ readonly "17": "ApplicationMismatch";
    /** something internally went wrong fetching image data*/ readonly "18": "InvalidDataUrl";
    /** not valid Base64 data*/ readonly "19": "InvalidBase64";
    /** you're trying to access the list before creating a stable list with Filter()*/ readonly "20": "NotFiltered";
    /** the lobby is full*/ readonly "21": "LobbyFull";
    /** the secret you're using to connect is wrong*/ readonly "22": "InvalidLobbySecret";
    /** file name is too long*/ readonly "23": "InvalidFilename";
    /** file is too large*/ readonly "24": "InvalidFileSize";
    /** the user does not have the right entitlement for this game*/ readonly "25": "InvalidEntitlement";
    /** Discord is not installed*/ readonly "26": "NotInstalled";
    /** Discord is not running*/ readonly "27": "NotRunning";
    /** insufficient buffer space when trying to write*/ readonly "28": "InsufficientBuffer";
    /** user cancelled the purchase flow*/ readonly "29": "PurchaseCancelled";
    /** Discord guild does not exist*/ readonly "30": "InvalidGuild";
    /** the event you're trying to subscribe to does not exist*/ readonly "31": "InvalidEvent";
    /** Discord channel does not exist*/ readonly "32": "InvalidChannel";
    /** the origin header on the socket does not match what you've registered (you should not see this)*/ readonly "33": "InvalidOrigin";
    /** you are calling that method too quickly*/ readonly "34": "RateLimited";
    /** the OAuth2 process failed at some point*/ readonly "35": "OAuth2Error";
    /** the user took too long selecting a channel for an invite*/ readonly "36": "SelectChannelTimeout";
    /** took too long trying to fetch the guild*/ readonly "37": "GetGuildTimeout";
    /** push to talk is required for this channel*/ readonly "38": "SelectVoiceForceRequired";
    /** that push to talk shortcut is already registered*/ readonly "39": "CaptureShortcutAlreadyListening";
    /** your application cannot update this achievement*/ readonly "40": "UnauthorizedForAchievement";
    /** the gift code is not valid*/ readonly "41": "InvalidGiftCode";
    /** something went wrong during the purchase flow*/ readonly "42": "PurchaseError";
    /** purchase flow aborted because the SDK is being torn down*/ readonly "43": "TransactionAborted";
};
export declare const LoglevelEnum: {
    /** Log only errors*/ readonly Error: "Error";
    /** Log warnings and errors*/ readonly Warning: "Warning";
    /** Log info, warnings, and errors*/ readonly Info: "Info";
    /** Log all the things!*/ readonly Debug: "Debug";
};
export declare const CreateflagsEnum: {
    /** Requires Discord to be running to play the game*/ readonly Default: "Default";
    /** Does not require Discord to be running, use this on other platforms*/ readonly Norequirediscord: "NoRequireDiscord";
};
...
export declare const ImagetypeEnum: {
    /** image is a user's avatar*/ readonly User: "User";
};
...
export declare const LobbysearchdistanceEnum: {
    /** within the same region*/ readonly Local: 0;
    /** within the same and adjacent regions*/ readonly Default: 1;
    /** far distances, like US to EU*/ readonly Extended: 2;
    /** all regions*/ readonly Global: 3;
};
...
export declare const RelationshiptypeEnum: {
    /** user has no intrinsic relationship*/ readonly None: "None";
    /** user is a friend*/ readonly Friend: "Friend";
    /** user is blocked*/ readonly Blocked: "Blocked";
    /** user has a pending incoming friend request to connected user*/ readonly Pendingincoming: "PendingIncoming";
    /** current user has a pending outgoing friend request to user*/ readonly Pendingoutgoing: "PendingOutgoing";
    /** user is not friends, but interacts with current user often (frequency + recency)*/ readonly Implicit: "Implicit";
};
...
export declare const SkutypeEnum: {
    /** SKU is a game*/ readonly Application: 1;
    /** SKU is a DLC*/ readonly Dlc: 2;
    /** SKU is a consumable (in-app purchase)*/ readonly Consumable: 3;
    /** SKU is a bundle (comprising the other 3 types)*/ readonly Bundle: 4;
};
export declare const EntitlementtypeEnum: {
    /** entitlement was purchased*/ readonly Purchase: 1;
    /** entitlement for a Discord Nitro subscription*/ readonly Premiumsubscription: 2;
    /** entitlement was gifted by a developer*/ readonly Developergift: 3;
    /** entitlement was purchased by a dev in application test mode*/ readonly Testmodepurchase: 4;
    /** entitlement was granted when the SKU was free*/ readonly Freepurchase: 5;
    /** entitlement was gifted by another user*/ readonly Usergift: 6;
    /** entitlement was claimed by user for free as a Nitro Subscriber*/ readonly Premiumpurchase: 7;
};
export declare const UserflagEnum: {
    /** Discord Partner*/ readonly Partner: 2;
    /** HypeSquad Events participant*/ readonly Hypesquadevents: 4;
    /** House Bravery*/ readonly Hypesquadhouse1: 64;
    /** House Brilliance*/ readonly Hypesquadhouse2: 128;
    /** House Balance*/ readonly Hypesquadhouse3: 256;
};
export declare const PremiumtypeEnum: {
    /** Not a Nitro subscriber*/ readonly None: 0;
    /** Nitro Classic subscriber*/ readonly Tier1: 1;
    /** Nitro subscriber*/ readonly Tier2: 2;
};
...
export declare const SnowflakeIdFormatStructureLeftToRight: {
    /** Milliseconds since Discord Epoch, the first second of 2015 or 1420070400000.*/ readonly Timestamp: "63 to 22";
    readonly InternalWorkerId: "21 to 17";
    readonly InternalProcessId: "16 to 12";
    /** For every ID that is generated on that process, this number is incremented*/ readonly Increment: "11 to 0";
};
export declare const TimestampStyles: {
    /** Short Time*/ readonly t: "16:20";
    /** Long Time*/ readonly T: "16:20:30";
    /** Short Date*/ readonly d: "20/04/2021";
    /** Long Date*/ readonly D: "20 April 2021";
    /** Short Date/Time*/ readonly f: "20 April 2021 16:20";
    /** Long Date/Time*/ readonly F: "Tuesday, 20 April 2021 16:20";
    /** Relative Time*/ readonly R: "2 months ago";
};
...
export declare const PremiumTier: {
    ...
    /** guild has unlocked Server Boost level 1 perks*/ readonly Tier1: 1;
    /** guild has unlocked Server Boost level 2 perks*/ readonly Tier2: 2;
    /** guild has unlocked Server Boost level 3 perks*/ readonly Tier3: 3;
};
...
export declare const UserFlags: {
    ...
    /** Bug Hunter Level 1*/ readonly BugHunterLevel1: 8;
    /** House Bravery Member*/ readonly HypesquadOnlineHouse1: 64;
    /** House Brilliance Member*/ readonly HypesquadOnlineHouse2: 128;
    /** House Balance Member*/ readonly HypesquadOnlineHouse3: 256;
    /** Early Nitro Supporter*/ readonly PremiumEarlySupporter: 512;
    /** User is a team*/ readonly TeamPseudoUser: 1024;
    /** Bug Hunter Level 2*/ readonly BugHunterLevel2: 16384;
...
export declare const UpdatePresencePayloadFields: {
    /** the user's current party status*/ readonly State: "char";
    /** what the player is currently doing*/ readonly Details: "char";
    /** epoch seconds for game start - including will show time as "elapsed*/ readonly Starttimestamp: "int64_t";
    /** epoch seconds for game end - including will show time as "remaining*/ readonly Endtimestamp: "int64_t";
    /** name of the uploaded image for the large profile artwork*/ readonly Largeimagekey: "char";
    /** tooltip for the largeImageKey*/ readonly Largeimagetext: "char";
    /** name of the uploaded image for the small profile artwork*/ readonly Smallimagekey: "char";
    /** tooltip for the smallImageKey*/ readonly Smallimagetext: "char";
    /** id of the player's party, lobby, or group*/ readonly Partyid: "char";
    /** current size of the player's party, lobby, or group*/ readonly Partysize: "int";
    /** maximum size of the player's party, lobby, or group*/ readonly Partymax: "int";
    /** (for future use) unique hashed string for a player's match*/ readonly Matchsecret: "char";
    /** unique hashed string for Spectate button*/ readonly Spectatesecret: "char";
    /** unique hashed string for chat invitations and Ask to Join*/ readonly Joinsecret: "char";
    /** (for future use) integer representing a boolean for if the player is in an instance (an in-progress match)*/ readonly Instance: "int8_t";
};
export declare const AskToJoinPayloadFields: {
    /** the userId of the player asking to join*/ readonly Userid: "char";
    /** the username of the player asking to join*/ readonly Username: "char";
    /** the discriminator of the player asking to join*/ readonly Discriminator: "char";
    /** the avatar hash of the player asking to join—see image formatting for how to retrieve the image*/ readonly Avatar: "char";
};
...
export declare const IpDiscovery: {
    /** Values 0x1 and 0x2 indicate request and response, respectively*/ readonly Type: "2 bytes";
    /** Message length excluding Type and Length fields (value 70)*/ readonly Length: "2 bytes";
    /** Unsigned integer*/ readonly Ssrc: "4 bytes";
    /** Null-terminated string in response*/ readonly Address: "64 bytes";
    /** Unsigned short*/ readonly Port: "2 bytes";
};
...
/** Returns all achievements for the given application. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ export declare function getAchievements(applicationId: string): Promise<any>;
/** Returns the given achievement for the given application. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ export declare function getAchievement(applicationId: string, achievementId: string): Promise<any>;
/** Creates a new achievement for your application. Applications can have a maximum of 1000 achievements. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ export declare function createAchievement(applicationId: string): Promise<any>;
/** Updates the achievement for \_\_ALL USERS\_\_. This is NOT to update a single user's achievement progress; this is to edit the UserAchievement itself. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ export declare function updateAchievement(applicationId: string, achievementId: string): Promise<any>;
/** Deletes the given achievement from your application. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ export declare function deleteAchievement(applicationId: string, achievementId: string): Promise<any>;
/** Updates the UserAchievement record for a given user. Use this endpoint to update secure achievement progress for users. This endpoint has a rate limit of 5 requests per 5 seconds per application.*/ export declare function updateUserAchievement(applicationId: string, achievementId: string): Promise<any>;
/** Returns a list of achievements for the user whose token you're making the request with. This endpoint will NOT accept the Bearer token for your application generated via the Client Crendentials Grant. You will need the user's bearer token, gotten via either the Authorization Code OAuth2 Grant or via the SDK with GetOAuth2Token. This endpoint has a rate limit of 2 requests per 5 seconds per application per user.*/ export declare function getUserAchievements(applicationId: string): Promise<any>;
/** Creates a new lobby. Returns an object similar to the SDK Lobby struct, documented below.*/ export declare function createLobby(): Promise<any>;
/** Updates a lobby.*/ export declare function updateLobby(lobbyId: string): Promise<any>;
/** Deletes a lobby.*/ export declare function deleteLobby(lobbyId: string): Promise<any>;
/** PATCH https://discord.com/api/v6/lobbies/<lobby_id>/members/<user_id>*/ export declare function updateLobbyMember(lobbyId: string, userId: string): Promise<any>;
/** Creates a lobby search for matchmaking around given criteria.*/ export declare function createLobbySearch(): Promise<any>;
/** Sends a message to the lobby, fanning it out to other lobby members.*/ export declare function sendLobbyData(lobbyId: string): Promise<any>;
/** Gets entitlements for a given user. You can use this on your game backend to check entitlements of an arbitrary user, or perhaps in an administrative panel for your support team.*/ export declare function getEntitlements(applicationId: string): Promise<any>;
/** Fetch an entitlement by its ID. This may be useful in confirming that a user has a given entitlement that another call or the SDK says they do.*/ export declare function getEntitlement(applicationId: string, entitlementId: string): Promise<any>;
/** Get all SKUs for an application.*/ export declare function getSkus(applicationId: string): Promise<any>;
/** Marks a given entitlement for the user as consumed, meaning it will no longer be returned in an entitlements check. Ensure the user was granted whatever items the entitlement was for before consuming it!*/ export declare function consumeSku(applicationId: string, entitlementId: string): Promise<any>;
/** Deletes a test entitlement for an application. You can only delete entitlements that were "purchased" in developer test mode; these are entitlements of type == TestModePurchase. You cannot use this route to delete arbitrary entitlements that users actually purchased.*/ export declare function deleteTestEntitlement(applicationId: string, entitlementId: string): Promise<any>;
/** Creates a discount for the given user on their next purchase of the given SKU. You should call this endpoint from your backend server just before calling StartPurchase for the SKU you wish to discount. The user will then see a discounted price for that SKU at time of payment. The discount is automatically consumed after successful purchase or if the TTL expires.*/ export declare function createPurchaseDiscount(skuId: string, userId: string): Promise<any>;
/** Deletes the currently active discount on the given SKU for the given user. You do not need to call this after a user has made a discounted purchase; successful discounted purchases will automatically remove the discount for that user for subsequent purchases.*/ export declare function deletePurchaseDiscount(skuId: string, userId: string): Promise<any>;
/** Fetch all of the global commands for your application. Returns an array of application command objects.*/ export declare function getGlobalApplicationCommands(applicationId: string): Promise<Array<ApplicationCommandStructure>>;
/** Create a new global command. New global commands will be available in all guilds after 1 hour. Returns 201 and an application command object.*/ export declare function createGlobalApplicationCommand(applicationId: string, body: toJSON<{
    /** 1-32 character name*/ "name": ApplicationCommandStructure;
    /** Localization dictionary for the name field. Values follow the same restrictions as name*/ "name_localizations"?: any | null;
    /** 1-100 character description*/ "description": string;
    /** Localization dictionary for the description field. Values follow the same restrictions as description*/ "description_localizations"?: any | null;
...
/** Fetch a global command for your application. Returns an application command object.*/ export declare function getGlobalApplicationCommand(applicationId: string, commandId: string): Promise<ApplicationCommandStructure>;
/** Edit a global command. Updates will be available in all guilds after 1 hour. Returns 200 and an application command object. All fields are optional, but any fields provided will entirely overwrite the existing values of those fields.*/ export declare function editGlobalApplicationCommand(applicationId: string, commandId: string, body: toJSON<Partial<{
    /** 1-32 character name*/ "name"?: ApplicationCommandStructure;
    /** Localization dictionary for the name field. Values follow the same restrictions as name*/ "name_localizations"?: any | null;
    /** 1-100 character description*/ "description"?: string;
    /** Localization dictionary for the description field. Values follow the same restrictions as description*/ "description_localizations"?: any | null;
...
/** Deletes a global command. Returns 204 No Content on success.*/ export declare function deleteGlobalApplicationCommand(applicationId: string, commandId: string): Promise<any>;
/** Takes a list of application commands, overwriting the existing global command list for this application. Updates will be available in all guilds after 1 hour. Returns 200 and a list of application command objects. Commands that do not already exist will count toward daily application command create limits.*/ export declare function bulkOverwriteGlobalApplicationCommands(applicationId: string): Promise<Array<ApplicationCommandStructure>>;
/** Fetch all of the guild commands for your application for a specific guild. Returns an array of application command objects.*/ export declare function getGuildApplicationCommands(applicationId: string, guildId: string): Promise<Array<ApplicationCommandStructure>>;
/** Create a new guild command. New guild commands will be available in the guild immediately. Returns 201 and an application command object. If the command did not already exist, it will count toward daily application command create limits.*/ export declare function createGuildApplicationCommand(applicationId: string, guildId: string, body: toJSON<{
    /** 1-32 character name*/ "name": ApplicationCommandStructure;
    /** Localization dictionary for the name field. Values follow the same restrictions as name*/ "name_localizations"?: any | null;
    /** 1-100 character description*/ "description": string;
    /** Localization dictionary for the description field. Values follow the same restrictions as description*/ "description_localizations"?: any | null;
...
/** Fetch a guild command for your application. Returns an application command object.*/ export declare function getGuildApplicationCommand(applicationId: string, guildId: string, commandId: string): Promise<ApplicationCommandStructure>;
/** Edit a guild command. Updates for guild commands will be available immediately. Returns 200 and an application command object. All fields are optional, but any fields provided will entirely overwrite the existing values of those fields.*/ export declare function editGuildApplicationCommand(applicationId: string, guildId: string, commandId: string, body: toJSON<Partial<{
    /** 1-32 character name*/ "name"?: ApplicationCommandStructure;
    /** Localization dictionary for the name field. Values follow the same restrictions as name*/ "name_localizations"?: any | null;
    /** 1-100 character description*/ "description"?: string;
    /** Localization dictionary for the description field. Values follow the same restrictions as description*/ "description_localizations"?: any | null;
...
/** Delete a guild command. Returns 204 No Content on success.*/ export declare function deleteGuildApplicationCommand(applicationId: string, guildId: string, commandId: string): Promise<any>;
/** Takes a list of application commands, overwriting the existing command list for this application for the targeted guild. Returns 200 and a list of application command objects.*/ export declare function bulkOverwriteGuildApplicationCommands(applicationId: string, guildId: string): Promise<Array<ApplicationCommandStructure>>;
/** Fetches command permissions for all commands for your application in a guild. Returns an array of guild application command permissions objects.*/ export declare function getGuildApplicationCommandPermissions(applicationId: string, guildId: string): Promise<Array<GuildApplicationCommandPermissionsStructure>>;
/** Fetches command permissions for a specific command for your application in a guild. Returns a guild application command permissions object.*/ export declare function getApplicationCommandPermissions(applicationId: string, guildId: string, commandId: string): Promise<GuildApplicationCommandPermissionsStructure>;
/** Edits command permissions for a specific command for your application in a guild. You can only add up to 10 permission overwrites for a command. Returns a GuildApplicationCommandPermissions object.*/ export declare function editApplicationCommandPermissions(applicationId: string, guildId: string, commandId: string, body: toJSON<{
    /** the permissions for the command in the guild*/ "permissions": Array<ApplicationCommandPermissionsStructure>;
}>): Promise<GuildApplicationCommandPermissionsStructure>;
/** Batch edits permissions for all commands in a guild. Takes an array of partial guild application command permissions objects including id and permissions.*/ export declare function batchEditApplicationCommandPermissions(applicationId: string, guildId: string): Promise<Array<GuildApplicationCommandPermissionsStructure>>;
/** Create a response to an Interaction from the gateway. Body is an interaction response. Returns 204 No Content.*/ export declare function createInteractionResponse(interactionId: string, interactionToken: string): Promise<any>;
/** Returns the initial Interaction response. Functions the same as Get Webhook Message.*/ export declare function getOriginalInteractionResponse(applicationId: string, interactionToken: string): Promise<any>;
/** Edits the initial Interaction response. Functions the same as Edit Webhook Message.*/ export declare function editOriginalInteractionResponse(applicationId: string, interactionToken: string, body: toJSON<Partial<{
...
/** Deletes the initial Interaction response. Returns 204 No Content on success. Does not support ephemeral followups.*/ export declare function deleteOriginalInteractionResponse(applicationId: string, interactionToken: string): Promise<any>;
/** Create a followup message for an Interaction. Functions the same as Execute Webhook, but wait is always true. The thread_id, avatar_url, and username parameters are not supported when using this endpoint for interaction followups.*/ export declare function createFollowupMessage(applicationId: string, interactionToken: string, body: toJSON<{
    /** the message contents (up to 2000 characters)*/ "content"?: string;
...
/** Returns a followup message for an Interaction. Functions the same as Get Webhook Message.*/ export declare function getFollowupMessage(applicationId: string, interactionToken: string, messageId: string): Promise<any>;
/** Edits a followup message for an Interaction. Functions the same as Edit Webhook Message.*/ export declare function editFollowupMessage(applicationId: string, interactionToken: string, messageId: string, body: toJSON<Partial<{
    /** the message contents (up to 2000 characters)*/ "content": string;
    /** embedded rich content*/ "embeds": Array<EmbedStructure>;
    /** allowed mentions for the message*/ "allowed_mentions": typeof AllowedMentionTypes[keyof typeof AllowedMentionTypes];
    /** the components to include with the message*/ "components": Array<ComponentTypes>;
...
/** Deletes a followup message for an Interaction. Returns 204 No Content on success. Does not support ephemeral followups.*/ export declare function deleteFollowupMessage(applicationId: string, interactionToken: string, messageId: string): Promise<any>;
/** Returns an audit log object for the guild. Requires the 'VIEW_AUDIT_LOG' permission.*/ export declare function getGuildAuditLog(guildId: string): Promise<AuditLogStructure>;
/** Get a channel by ID. Returns a channel object. If the channel is a thread, a thread member object is included in the returned result.*/ export declare function getChannel(channelId: string): Promise<ChannelStructure>;
/** Update a channel's settings. Returns a channel on success, and a 400 BAD REQUEST on invalid parameters. All JSON parameters are optional.*/ export declare function modifyChannel(channelId: string, body: toJSON<Partial<{
...
/** Delete a channel, or close a private message. Requires the MANAGE_CHANNELS permission for the guild, or MANAGE_THREADS if the channel is a thread. Deleting a category does not delete its child channels; they will have their parent_id removed and a Channel Update Gateway event will fire for each of them. Returns a channel object on success. Fires a Channel Delete Gateway event (or Thread Delete if the channel was a thread).*/ export declare function deleteCloseChannel(channelId: string): Promise<ChannelStructure>;
/** Returns the messages for a channel. If operating on a guild channel, this endpoint requires the VIEW_CHANNEL permission to be present on the current user. If the current user is missing the 'READ_MESSAGE_HISTORY' permission in the channel then this will return no messages (since they cannot read the message history). Returns an array of message objects on success.*/ export declare function getChannelMessages(channelId: string): Promise<Array<MessageStructure>>;
/** Returns a specific message in the channel. If operating on a guild channel, this endpoint requires the 'READ_MESSAGE_HISTORY' permission to be present on the current user. Returns a message object on success.*/ export declare function getChannelMessage(channelId: string, messageId: string): Promise<any>;
/** Post a message to a guild text or DM channel. Returns a message object. Fires a Message Create Gateway event. See message formatting for more information on how to properly format messages.*/ export declare function createMessage(channelId: string, body: toJSON<Partial<{
    /** the message contents (up to 2000 characters)*/ "content"?: string;
    /** true if this is a TTS message*/ "tts"?: boolean;
...
/** Crosspost a message in a News Channel to following channels. This endpoint requires the 'SEND_MESSAGES' permission, if the current user sent the message, or additionally the 'MANAGE_MESSAGES' permission, for all other messages, to be present for the current user.*/ export declare function crosspostMessage(channelId: string, messageId: string): Promise<MessageStructure>;
/** Create a reaction for the message. This endpoint requires the 'READ_MESSAGE_HISTORY' permission to be present on the current user. Additionally, if nobody else has reacted to the message using this emoji, this endpoint requires the 'ADD_REACTIONS' permission to be present on the current user. Returns a 204 empty response on success. The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id.*/ export declare function createReaction(channelId: string, messageId: string, emoji: string): Promise<any>;
/** Delete a reaction the current user has made for the message. Returns a 204 empty response on success. The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id.*/ export declare function deleteOwnReaction(channelId: string, messageId: string, emoji: string): Promise<any>;
/** Deletes another user's reaction. This endpoint requires the 'MANAGE_MESSAGES' permission to be present on the current user. Returns a 204 empty response on success. The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id.*/ export declare function deleteUserReaction(channelId: string, messageId: string, emoji: string, userId: string): Promise<any>;
/** Get a list of users that reacted with this emoji. Returns an array of user objects on success. The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id.*/ export declare function getReactions(channelId: string, messageId: string, emoji: string): Promise<Array<UserStructure>>;
/** Deletes all reactions on a message. This endpoint requires the 'MANAGE_MESSAGES' permission to be present on the current user. Fires a Message Reaction Remove All Gateway event.*/ export declare function deleteAllReactions(channelId: string, messageId: string): Promise<any>;
/** Deletes all the reactions for a given emoji on a message. This endpoint requires the MANAGE_MESSAGES permission to be present on the current user. Fires a Message Reaction Remove Emoji Gateway event. The emoji must be URL Encoded or the request will fail with 10014: Unknown Emoji. To use custom emoji, you must encode it in the format name:id with the emoji name and emoji id.*/ export declare function deleteAllReactionsForEmoji(channelId: string, messageId: string, emoji: string): Promise<any>;
/** Edit a previously sent message. The fields content, embeds, and flags can be edited by the original message author. Other users can only edit flags and only if they have the MANAGE_MESSAGES permission in the corresponding channel. When specifying flags, ensure to include all previously set flags/bits in addition to ones that you are modifying. Only flags documented in the table below may be modified by users (unsupported flag changes are currently ignored without error).*/ export declare function editMessage(channelId: string, messageId: string, body: toJSON<Partial<{
    /** the message contents (up to 2000 characters)*/ "content": string;
    /** embedded rich content (up to 6000 characters)*/ "embeds": Array<EmbedStructure>;
    /** embedded rich content, deprecated in favor of embeds*/ "embed": EmbedStructure;
...
/** Delete a message. If operating on a guild channel and trying to delete a message that was not sent by the current user, this endpoint requires the MANAGE_MESSAGES permission. Returns a 204 empty response on success. Fires a Message Delete Gateway event.*/ export declare function deleteMessage(channelId: string, messageId: string): Promise<any>;
/** Delete multiple messages in a single request. This endpoint can only be used on guild channels and requires the MANAGE_MESSAGES permission. Returns a 204 empty response on success. Fires a Message Delete Bulk Gateway event.*/ export declare function bulkDeleteMessages(channelId: string, body: toJSON<{
    /** an array of message ids to delete (2-100)*/ "messages": string | bigint;
}>): Promise<any>;
/** Edit the channel permission overwrites for a user or role in a channel. Only usable for guild channels. Requires the MANAGE_ROLES permission. Only permissions your bot has in the guild or parent channel (if applicable) can be allowed/denied (unless your bot has a MANAGE_ROLES overwrite in the channel). Returns a 204 empty response on success. For more information about permissions, see permissions.*/ export declare function editChannelPermissions(channelId: string, overwriteId: string, body: toJSON<{
...
/** Returns a list of invite objects (with invite metadata) for the channel. Only usable for guild channels. Requires the MANAGE_CHANNELS permission.*/ export declare function getChannelInvites(channelId: string): Promise<Array<InviteStructure>>;
/** Create a new invite object for the channel. Only usable for guild channels. Requires the CREATE_INSTANT_INVITE permission. All JSON parameters for this route are optional, however the request body is not. If you are not sending any fields, you still have to send an empty JSON object ({}). Returns an invite object. Fires an Invite Create Gateway event.*/ export declare function createChannelInvite(channelId: string, body: toJSON<Partial<{
...
/** Delete a channel permission overwrite for a user or role in a channel. Only usable for guild channels. Requires the MANAGE_ROLES permission. Returns a 204 empty response on success. For more information about permissions, see permissions*/ export declare function deleteChannelPermission(channelId: string, overwriteId: string): Promise<any>;
/** Follow a News Channel to send messages to a target channel. Requires the MANAGE_WEBHOOKS permission in the target channel. Returns a followed channel object.*/ export declare function followNewsChannel(channelId: string, body: toJSON<{
    /** id of target channel*/ "webhook_channel_id": string | bigint;
}>): Promise<FollowedChannelStructure>;
/** Post a typing indicator for the specified channel. Generally bots should not implement this route. However, if a bot is responding to a command and expects the computation to take a few seconds, this endpoint may be called to let the user know that the bot is processing their message. Returns a 204 empty response on success. Fires a Typing Start Gateway event.*/ export declare function triggerTypingIndicator(channelId: string): Promise<any>;
/** Returns all pinned messages in the channel as an array of message objects.*/ export declare function getPinnedMessages(channelId: string): Promise<Array<MessageStructure>>;
/** Pin a message in a channel. Requires the MANAGE_MESSAGES permission. Returns a 204 empty response on success.*/ export declare function pinMessage(channelId: string, messageId: string): Promise<any>;
/** Unpin a message in a channel. Requires the MANAGE_MESSAGES permission. Returns a 204 empty response on success.*/ export declare function unpinMessage(channelId: string, messageId: string): Promise<any>;
/** Adds a recipient to a Group DM using their access token.*/ export declare function groupDmAddRecipient(channelId: string, userId: string, body: toJSON<{
...
/** Removes a recipient from a Group DM.*/ export declare function groupDmRemoveRecipient(channelId: string, userId: string): Promise<any>;
/** Creates a new thread from an existing message. Returns a channel on success, and a 400 BAD REQUEST on invalid parameters. Fires a Thread Create Gateway event.*/ export declare function startThreadWithMessage(channelId: string, messageId: string, body: toJSON<{
    /** 1-100 character channel name*/ "name": string;
    /** duration in minutes to automatically archive the thread after recent activity, can be set to: 60, 1440, 4320, 10080*/ "auto_archive_duration"?: number;
    /** amount of seconds a user has to wait before sending another message (0-21600)*/ "rate_limit_per_user"?: number | null;
}>): Promise<ChannelStructure>;
/** Creates a new thread that is not connected to an existing message. The created thread defaults to a GUILD_PRIVATE_THREAD*. Returns a channel on success, and a 400 BAD REQUEST on invalid parameters. Fires a Thread Create Gateway event.*/ export declare function startThreadWithoutMessage(channelId: string, body: toJSON<{
    /** 1-100 character channel name*/ "name": string;
    /** duration in minutes to automatically archive the thread after recent activity, can be set to: 60, 1440, 4320, 10080*/ "auto_archive_duration"?: number;
...
/** Adds the current user to a thread. Also requires the thread is not archived. Returns a 204 empty response on success. Fires a Thread Members Update Gateway event.*/ export declare function joinThread(channelId: string): Promise<any>;
/** Adds another member to a thread. Requires the ability to send messages in the thread. Also requires the thread is not archived. Returns a 204 empty response if the member is successfully added or was already a member of the thread. Fires a Thread Members Update Gateway event.*/ export declare function addThreadMember(channelId: string, userId: string): Promise<any>;
/** Removes the current user from a thread. Also requires the thread is not archived. Returns a 204 empty response on success. Fires a Thread Members Update Gateway event.*/ export declare function leaveThread(channelId: string): Promise<any>;
/** Removes another member from a thread. Requires the MANAGE_THREADS permission, or the creator of the thread if it is a GUILD_PRIVATE_THREAD. Also requires the thread is not archived. Returns a 204 empty response on success. Fires a Thread Members Update Gateway event.*/ export declare function removeThreadMember(channelId: string, userId: string): Promise<any>;
/** Returns a thread member object for the specified user if they are a member of the thread, returns a 404 response otherwise.*/ export declare function getThreadMember(channelId: string, userId: string): Promise<ThreadMemberStructure>;
/** Returns array of thread members objects that are members of the thread.*/ export declare function listThreadMembers(channelId: string): Promise<Array<ThreadMemberStructure>>;
/** Returns all active threads in the channel, including public and private threads. Threads are ordered by their id, in descending order.*/ export declare function listActiveThreads(channelId: string): Promise<{
...
/** Returns archived threads in the channel that are public. When called on a GUILD_TEXT channel, returns threads of type GUILD_PUBLIC_THREAD. When called on a GUILD_NEWS channel returns threads of type GUILD_NEWS_THREAD. Threads are ordered by archive_timestamp, in descending order. Requires the READ_MESSAGE_HISTORY permission.*/ export declare function listPublicArchivedThreads(channelId: string): Promise<typeof ChannelTypes[keyof typeof ChannelTypes]>;
/** Returns archived threads in the channel that are of type GUILD_PRIVATE_THREAD. Threads are ordered by archive_timestamp, in descending order. Requires both the READ_MESSAGE_HISTORY and MANAGE_THREADS permissions.*/ export declare function listPrivateArchivedThreads(channelId: string): Promise<typeof ChannelTypes[keyof typeof ChannelTypes]>;
/** Returns archived threads in the channel that are of type GUILD_PRIVATE_THREAD, and the user has joined. Threads are ordered by their id, in descending order. Requires the READ_MESSAGE_HISTORY permission.*/ export declare function listJoinedPrivateArchivedThreads(channelId: string): Promise<typeof ChannelTypes[keyof typeof ChannelTypes]>;
/** Returns a list of emoji objects for the given guild.*/ export declare function listGuildEmojis(guildId: string): Promise<Array<EmojiStructure>>;
/** Returns an emoji object for the given guild and emoji IDs.*/ export declare function getGuildEmoji(guildId: string, emojiId: string): Promise<EmojiStructure>;
/** Create a new emoji for the guild. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns the new emoji object on success. Fires a Guild Emojis Update Gateway event.*/ export declare function createGuildEmoji(guildId: string, body: toJSON<{
...
/** Modify the given emoji. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns the updated emoji object on success. Fires a Guild Emojis Update Gateway event.*/ export declare function modifyGuildEmoji(guildId: string, emojiId: string, body: toJSON<Partial<{
    /** name of the emoji*/ "name": string;
    /** roles allowed to use this emoji*/ "roles": (string | bigint) | null;
}>>): Promise<EmojiStructure>;
/** Delete the given emoji. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns 204 No Content on success. Fires a Guild Emojis Update Gateway event.*/ export declare function deleteGuildEmoji(guildId: string, emojiId: string): Promise<any>;
/** Create a new guild. Returns a guild object on success. Fires a Guild Create Gateway event.*/ export declare function createGuild(body: toJSON<{
...
/** Returns the guild object for the given id. If with_counts is set to true, this endpoint will also return approximate_member_count and approximate_presence_count for the guild.*/ export declare function getGuild(guildId: string): Promise<GuildStructure>;
/** Returns the guild preview object for the given id. If the user is not in the guild, then the guild must be lurkable.*/ export declare function getGuildPreview(guildId: string): Promise<GuildPreviewStructure>;
/** Modify a guild's settings. Requires the MANAGE_GUILD permission. Returns the updated guild object on success. Fires a Guild Update Gateway event.*/ export declare function modifyGuild(guildId: string, body: toJSON<Partial<{
    /** guild name*/ "name": string;
...
/** Delete a guild permanently. User must be owner. Returns 204 No Content on success. Fires a Guild Delete Gateway event.*/ export declare function deleteGuild(guildId: string): Promise<any>;
/** Returns a list of guild channel objects. Does not include threads.*/ export declare function getGuildChannels(guildId: string): Promise<Array<ChannelStructure>>;
/** Create a new channel object for the guild. Requires the MANAGE_CHANNELS permission. If setting permission overwrites, only permissions your bot has in the guild can be allowed/denied. Setting MANAGE_ROLES permission in channels is only possible for guild administrators. Returns the new channel object on success. Fires a Channel Create Gateway event.*/ export declare function createGuildChannel(guildId: string, body: toJSON<Partial<{
...
/** Modify the positions of a set of channel objects for the guild. Requires MANAGE_CHANNELS permission. Returns a 204 empty response on success. Fires multiple Channel Update Gateway events.*/ export declare function modifyGuildChannelPositions(guildId: string, body: toJSON<{
...
/** Returns all active threads in the guild, including public and private threads. Threads are ordered by their id, in descending order.*/ export declare function listActiveThreads_(guildId: string): Promise<{
    /** the active threads*/ "threads": Array<ChannelStructure>;
    /** a thread member object for each returned thread the current user has joined*/ "members": Array<ThreadMemberStructure>;
}>;
/** Returns a guild member object for the specified user.*/ export declare function getGuildMember(guildId: string, userId: string): Promise<GuildMemberStructure>;
/** Returns a list of guild member objects that are members of the guild.*/ export declare function listGuildMembers(guildId: string): Promise<Array<GuildMemberStructure>>;
/** Returns a list of guild member objects whose username or nickname starts with a provided string.*/ export declare function searchGuildMembers(guildId: string): Promise<Array<GuildMemberStructure>>;
/** Adds a user to the guild, provided you have a valid oauth2 access token for the user with the guilds.join scope. Returns a 201 Created with the guild member as the body, or 204 No Content if the user is already a member of the guild. Fires a Guild Member Add Gateway event.*/ export declare function addGuildMember(guildId: string, userId: string, body: toJSON<Partial<{
...
/** Modify attributes of a guild member. Returns a 200 OK with the guild member as the body. Fires a Guild Member Update Gateway event. If the channel_id is set to null, this will force the target user to be disconnected from voice.*/ export declare function modifyGuildMember(guildId: string, userId: string, body: toJSON<Partial<{
    /** value to set user's nickname to*/ "nick": string;
    /** array of role ids the member is assigned*/ "roles": string | bigint;
...
/** Modifies the current member in a guild. Returns a 200 with the updated member object on success. Fires a Guild Member Update Gateway event.*/ export declare function modifyCurrentMember(guildId: string, body: toJSON<{
    /** value to set user's nickname to*/ "nick"?: string | null;
}>): Promise<any>;
/** Modifies the nickname of the current user in a guild. Returns a 200 with the nickname on success. Fires a Guild Member Update Gateway event.*/ export declare function modifyCurrentUserNick(guildId: string, body: toJSON<{
    /** value to set user's nickname to*/ "nick"?: string | null;
}>): Promise<any>;
/** Adds a role to a guild member. Requires the MANAGE_ROLES permission. Returns a 204 empty response on success. Fires a Guild Member Update Gateway event.*/ export declare function addGuildMemberRole(guildId: string, userId: string, roleId: string): Promise<any>;
/** Removes a role from a guild member. Requires the MANAGE_ROLES permission. Returns a 204 empty response on success. Fires a Guild Member Update Gateway event.*/ export declare function removeGuildMemberRole(guildId: string, userId: string, roleId: string): Promise<any>;
/** Remove a member from a guild. Requires KICK_MEMBERS permission. Returns a 204 empty response on success. Fires a Guild Member Remove Gateway event.*/ export declare function removeGuildMember(guildId: string, userId: string): Promise<any>;
/** Returns a list of ban objects for the users banned from this guild. Requires the BAN_MEMBERS permission.*/ export declare function getGuildBans(guildId: string): Promise<Array<BanStructure>>;
/** Returns a ban object for the given user or a 404 not found if the ban cannot be found. Requires the BAN_MEMBERS permission.*/ export declare function getGuildBan(guildId: string, userId: string): Promise<BanStructure>;
/** Create a guild ban, and optionally delete previous messages sent by the banned user. Requires the BAN_MEMBERS permission. Returns a 204 empty response on success. Fires a Guild Ban Add Gateway event.*/ export declare function createGuildBan(guildId: string, userId: string, body: toJSON<Partial<{
    /** number of days to delete messages for (0-7)*/ "delete_message_days"?: number;
    /** reason for the ban (deprecated)*/ "reason"?: string;
}>>): Promise<any>;
/** Remove the ban for a user. Requires the BAN_MEMBERS permissions. Returns a 204 empty response on success. Fires a Guild Ban Remove Gateway event.*/ export declare function removeGuildBan(guildId: string, userId: string): Promise<any>;
/** Returns a list of role objects for the guild.*/ export declare function getGuildRoles(guildId: string): Promise<Array<RoleStructure>>;
/** Create a new role for the guild. Requires the MANAGE_ROLES permission. Returns the new role object on success. Fires a Guild Role Create Gateway event. All JSON params are optional.*/ export declare function createGuildRole(guildId: string, body: toJSON<Partial<{
...
/** Modify the positions of a set of role objects for the guild. Requires the MANAGE_ROLES permission. Returns a list of all of the guild's role objects on success. Fires multiple Guild Role Update Gateway events.*/ export declare function modifyGuildRolePositions(guildId: string, body: toJSON<{
    /** role*/ "id": string | bigint;
    /** sorting position of the role*/ "position"?: number | null;
}>): Promise<Array<RoleStructure>>;
/** Modify a guild role. Requires the MANAGE_ROLES permission. Returns the updated role on success. Fires a Guild Role Update Gateway event.*/ export declare function modifyGuildRole(guildId: string, roleId: string, body: toJSON<Partial<{
    /** name of the role*/ "name": string;
    /** bitwise value of the enabled/disabled permissions*/ "permissions": string;
    /** RGB color value*/ "color": number;
    /** whether the role should be displayed separately in the sidebar*/ "hoist": boolean;
...
/** Delete a guild role. Requires the MANAGE_ROLES permission. Returns a 204 empty response on success. Fires a Guild Role Delete Gateway event.*/ export declare function deleteGuildRole(guildId: string, roleId: string): Promise<any>;
/** Returns an object with one 'pruned' key indicating the number of members that would be removed in a prune operation. Requires the KICK_MEMBERS permission.*/ export declare function getGuildPruneCount(guildId: string): Promise<any>;
/** Begin a prune operation. Requires the KICK_MEMBERS permission. Returns an object with one 'pruned' key indicating the number of members that were removed in the prune operation. For large guilds it's recommended to set the compute_prune_count option to false, forcing 'pruned' to null. Fires multiple Guild Member Remove Gateway events.*/ export declare function beginGuildPrune(guildId: string, body: toJSON<Partial<{
...
/** Returns a list of voice region objects for the guild. Unlike the similar /voice route, this returns VIP servers when the guild is VIP-enabled.*/ export declare function getGuildVoiceRegions(guildId: string): Promise<Array<VoiceRegionStructure>>;
/** Returns a list of invite objects (with invite metadata) for the guild. Requires the MANAGE_GUILD permission.*/ export declare function getGuildInvites(guildId: string): Promise<Array<InviteStructure>>;
/** Returns a list of integration objects for the guild. Requires the MANAGE_GUILD permission.*/ export declare function getGuildIntegrations(guildId: string): Promise<Array<IntegrationStructure>>;
/** Delete the attached integration object for the guild. Deletes any associated webhooks and kicks the associated bot if there is one. Requires the MANAGE_GUILD permission. Returns a 204 empty response on success. Fires a Guild Integrations Update Gateway event.*/ export declare function deleteGuildIntegration(guildId: string, integrationId: string): Promise<any>;
/** Returns a guild widget settings object. Requires the MANAGE_GUILD permission.*/ export declare function getGuildWidgetSettings(guildId: string): Promise<GuildWidgetSettingsStructure>;
/** Modify a guild widget settings object for the guild. All attributes may be passed in with JSON and modified. Requires the MANAGE_GUILD permission. Returns the updated guild widget object.*/ export declare function modifyGuildWidget(guildId: string): Promise<GuildWidgetSettingsStructure>;
/** Returns the widget for the guild.*/ export declare function getGuildWidget(guildId: string): Promise<GetGuildWidgetStructure>;
/** Returns a partial invite object for guilds with that feature enabled. Requires the MANAGE_GUILD permission. code will be null if a vanity url for the guild is not set.*/ export declare function getGuildVanityUrl(guildId: string): Promise<Partial<InviteStructure>>;
/** Returns a PNG image widget for the guild. Requires no permissions or authentication.*/ export declare function getGuildWidgetImage(guildId: string): Promise<any>;
/** Returns the Welcome Screen object for the guild. If the welcome screen is not enabled, the MANAGE_GUILD permission is required.*/ export declare function getGuildWelcomeScreen(guildId: string): Promise<WelcomeScreenStructure>;
/** Modify the guild's Welcome Screen. Requires the MANAGE_GUILD permission. Returns the updated Welcome Screen object.*/ export declare function modifyGuildWelcomeScreen(guildId: string, body: toJSON<Partial<{
...
/** Updates the current user's voice state. Returns 204 No Content on success.*/ export declare function modifyCurrentUserVoiceState(guildId: string, body: toJSON<{
...
/** Updates another user's voice state.*/ export declare function modifyUserVoiceState(guildId: string, userId: string, body: toJSON<{
    /** the id of the channel the user is currently in*/ "channel_id": string | bigint;
    /** toggles the user's suppress state*/ "suppress"?: boolean;
}>): Promise<any>;
/** Returns a list of guild scheduled event objects for the given guild.*/ export declare function listScheduledEventsForGuild(guildId: string): Promise<Array<GuildScheduledEventStructure>>;
/** Create a guild scheduled event in the guild. Returns a guild scheduled event object on success.*/ export declare function createGuildScheduledEvent(guildId: string, body: toJSON<{
...
/** Get a guild scheduled event. Returns a guild scheduled event object on success.*/ export declare function getGuildScheduledEvent(guildId: string, guildScheduledEventId: string): Promise<GuildScheduledEventStructure>;
/** Modify a guild scheduled event. Returns the modified guild scheduled event object on success.*/ export declare function modifyGuildScheduledEvent(guildId: string, guildScheduledEventId: string, body: toJSON<{
...
/** Delete a guild scheduled event. Returns a 204 on success.*/ export declare function deleteGuildScheduledEvent(guildId: string, guildScheduledEventId: string): Promise<any>;
/** Get a list of guild scheduled event users subscribed to a guild scheduled event. Returns a list of guild scheduled event user objects on success. Guild member data, if it exists, is included if the with_member query parameter is set.*/ export declare function getGuildScheduledEventUsers(guildId: string, guildScheduledEventId: string): Promise<Array<GuildScheduledEventUserStructure>>;
/** Returns a guild template object for the given code.*/ export declare function getGuildTemplate(templateCode: string): Promise<GuildTemplateStructure>;
/** Create a new guild based on a template. Returns a guild object on success. Fires a Guild Create Gateway event.*/ export declare function createGuildFromGuildTemplate(templateCode: string, body: toJSON<{
    /** name of the guild (2-100 characters)*/ "name": string;
    /** base64 128x128 image for the guild icon*/ "icon"?: any;
}>): Promise<GuildStructure>;
/** Returns an array of guild template objects. Requires the MANAGE_GUILD permission.*/ export declare function getGuildTemplates(guildId: string): Promise<Array<GuildTemplateStructure>>;
/** Creates a template for the guild. Requires the MANAGE_GUILD permission. Returns the created guild template object on success.*/ export declare function createGuildTemplate(guildId: string, body: toJSON<{
...
/** Syncs the template to the guild's current state. Requires the MANAGE_GUILD permission. Returns the guild template object on success.*/ export declare function syncGuildTemplate(guildId: string, templateCode: string): Promise<GuildTemplateStructure>;
/** Modifies the template's metadata. Requires the MANAGE_GUILD permission. Returns the guild template object on success.*/ export declare function modifyGuildTemplate(guildId: string, templateCode: string, body: toJSON<{
    /** name of the template (1-100 characters)*/ "name"?: string;
    /** description for the template (0-120 characters)*/ "description"?: string | null;
}>): Promise<GuildTemplateStructure>;
/** Deletes the template. Requires the MANAGE_GUILD permission. Returns the deleted guild template object on success.*/ export declare function deleteGuildTemplate(guildId: string, templateCode: string): Promise<GuildTemplateStructure>;
/** Returns an invite object for the given code.*/ export declare function getInvite(inviteCode: string): Promise<InviteStructure>;
/** Delete an invite. Requires the MANAGE_CHANNELS permission on the channel this invite belongs to, or MANAGE_GUILD to remove any invite across the guild. Returns an invite object on success. Fires a Invite Delete Gateway event.*/ export declare function deleteInvite(inviteCode: string): Promise<InviteStructure>;
/** Creates a new Stage instance associated to a Stage channel. Returns that Stage instance.*/ export declare function createStageInstance(body: toJSON<{
...
/** Gets the stage instance associated with the Stage channel, if it exists.*/ export declare function getStageInstance(channelId: string): Promise<any>;
/** Updates fields of an existing Stage instance. Returns the updated Stage instance.*/ export declare function modifyStageInstance(channelId: string, body: toJSON<{
    /** The topic of the Stage instance (1-120 characters)*/ "topic"?: string;
    /** The privacy level of the Stage instance*/ "privacy_level"?: typeof PrivacyLevel[keyof typeof PrivacyLevel];
}>): Promise<StageInstanceStructure>;
/** Deletes the Stage instance. Returns 204 No Content.*/ export declare function deleteStageInstance(channelId: string): Promise<any>;
/** Returns a sticker object for the given sticker ID.*/ export declare function getSticker(stickerId: string): Promise<StickerStructure>;
/** Returns the list of sticker packs available to Nitro subscribers.*/ export declare function listNitroStickerPacks(): Promise<{
    "sticker_packs": Array<StickerPackStructure>;
}>;
/** Returns an array of sticker objects for the given guild. Includes user fields if the bot has the MANAGE_EMOJIS_AND_STICKERS permission.*/ export declare function listGuildStickers(guildId: string): Promise<Array<StickerStructure>>;
/** Returns a sticker object for the given guild and sticker IDs. Includes the user field if the bot has the MANAGE_EMOJIS_AND_STICKERS permission.*/ export declare function getGuildSticker(guildId: string, stickerId: string): Promise<StickerStructure>;
/** Create a new sticker for the guild. Send a multipart/form-data body. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns the new sticker object on success.*/ export declare function createGuildSticker(guildId: string, body: toJSON<{
...
/** Modify the given sticker. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns the updated sticker object on success.*/ export declare function modifyGuildSticker(guildId: string, stickerId: string, body: toJSON<Partial<{
    /** name of the sticker (2-30 characters)*/ "name": string;
    /** description of the sticker (2-100 characters)*/ "description": string | null;
    /** autocomplete/suggestion tags for the sticker (max 200 characters)*/ "tags": string;
}>>): Promise<StickerStructure>;
/** Delete the given sticker. Requires the MANAGE_EMOJIS_AND_STICKERS permission. Returns 204 No Content on success.*/ export declare function deleteGuildSticker(guildId: string, stickerId: string): Promise<any>;
/** Returns the user object of the requester's account. For OAuth2, this requires the identify scope, which will return the object without an email, and optionally the email scope, which returns the object with an email.*/ export declare function getCurrentUser(): Promise<UserStructure>;
/** Returns a user object for a given user ID.*/ export declare function getUser(userId: string): Promise<UserStructure>;
/** Modify the requester's user account settings. Returns a user object on success.*/ export declare function modifyCurrentUser(body: toJSON<Partial<{
...
/** Returns a list of partial guild objects the current user is a member of. Requires the guilds OAuth2 scope.*/ export declare function getCurrentUserGuilds(): Promise<Array<Partial<GuildStructure>>>;
/** Returns a guild member object for the current user. Requires the guilds.members.read OAuth2 scope.*/ export declare function getCurrentUserGuildMember(guildId: string): Promise<GuildMemberStructure>;
/** Leave a guild. Returns a 204 empty response on success.*/ export declare function leaveGuild(guildId: string): Promise<any>;
/** Create a new DM channel with a user. Returns a DM channel object.*/ export declare function createDm(body: toJSON<{
    /** the recipient to open a DM channel with*/ "recipient_id": string | bigint;
}>): Promise<ChannelStructure>;
/** Create a new group DM channel with multiple users. Returns a DM channel object. This endpoint was intended to be used with the now-deprecated GameBridge SDK. DMs created with this endpoint will not be shown in the Discord client*/ export declare function createGroupDm(body: toJSON<{
...
/** Returns a list of connection objects. Requires the connections OAuth2 scope.*/ export declare function getUserConnections(): Promise<Array<ConnectionStructure>>;
/** Returns an array of voice region objects that can be used when setting a voice or stage channel's `rtc_region`.*/ export declare function listVoiceRegions(): Promise<Array<VoiceRegionStructure>>;
/** Creates a new webhook and returns a webhook object on success. Requires the MANAGE_WEBHOOKS permission.*/ export declare function createWebhook(channelId: string, body: toJSON<{
...
/** Returns a list of channel webhook objects. Requires the MANAGE_WEBHOOKS permission.*/ export declare function getChannelWebhooks(channelId: string): Promise<Array<WebhookStructure>>;
/** Returns a list of guild webhook objects. Requires the MANAGE_WEBHOOKS permission.*/ export declare function getGuildWebhooks(guildId: string): Promise<Array<WebhookStructure>>;
/** Returns the new webhook object for the given id.*/ export declare function getWebhook(webhookId: string): Promise<WebhookStructure>;
/** Same as above, except this call does not require authentication and returns no user in the webhook object.*/ export declare function getWebhookWithToken(webhookId: string, webhookToken: string): Promise<any>;
/** Modify a webhook. Requires the MANAGE_WEBHOOKS permission. Returns the updated webhook object on success.*/ export declare function modifyWebhook(webhookId: string, body: toJSON<Partial<{
    /** the default name of the webhook*/ "name": string;
    /** image for the default webhook avatar*/ "avatar": any | null;
    /** the new channel id this webhook should be moved to*/ "channel_id": string | bigint;
}>>): Promise<WebhookStructure>;
/** Same as above, except this call does not require authentication, does not accept a channel_id parameter in the body, and does not return a user in the webhook object.*/ export declare function modifyWebhookWithToken(webhookId: string, webhookToken: string): Promise<any>;
/** Delete a webhook permanently. Requires the MANAGE_WEBHOOKS permission. Returns a 204 No Content response on success.*/ export declare function deleteWebhook(webhookId: string): Promise<any>;
/** Same as above, except this call does not require authentication.*/ export declare function deleteWebhookWithToken(webhookId: string, webhookToken: string): Promise<any>;
/** Refer to Uploading Files for details on attachments and multipart/form-data requests. Returns a message or 204 No Content depending on the wait query parameter.*/ export declare function executeWebhook(webhookId: string, webhookToken: string, body: toJSON<{
    /** the message contents (up to 2000 characters)*/ "content"?: string;
    /** override the default username of the webhook*/ "username"?: string;
    /** override the default avatar of the webhook*/ "avatar_url"?: string;
    /** true if this is a TTS message*/ "tts"?: boolean;
...
/** Refer to Slack's documentation for more information. We do not support Slack's channel, icon_emoji, mrkdwn, or mrkdwn_in properties.*/ export declare function executeSlackCompatibleWebhook(webhookId: string, webhookToken: string): Promise<any>;
/** Add a new webhook to your GitHub repo (in the repo's settings), and use this endpoint as the "Payload URL." You can choose what events your Discord channel receives by choosing the "Let me select individual events" option and selecting individual events for the new webhook you're configuring.*/ export declare function executeGithubCompatibleWebhook(webhookId: string, webhookToken: string): Promise<any>;
/** Returns a previously-sent webhook message from the same token. Returns a message object on success.*/ export declare function getWebhookMessage(webhookId: string, webhookToken: string, messageId: string): Promise<any>;
/** Edits a previously-sent webhook message from the same token. Returns a message object on success.*/ export declare function editWebhookMessage(webhookId: string, webhookToken: string, messageId: string, body: toJSON<Partial<{
    /** the message contents (up to 2000 characters)*/ "content": string;
    /** embedded rich content*/ "embeds": Array<EmbedStructure>;
    /** allowed mentions for the message*/ "allowed_mentions": typeof AllowedMentionTypes[keyof typeof AllowedMentionTypes];
    /** the components to include with the message*/ "components": Array<ComponentTypes>;
...
/** Deletes a message that was created by the webhook. Returns a 204 No Content response on success.*/ export declare function deleteWebhookMessage(webhookId: string, webhookToken: string, messageId: string): Promise<any>;
/** Returns an object with a single valid WSS URL, which the client can use for Connecting. Clients should cache this value and only call this endpoint to retrieve a new URL if they are unable to properly establish a connection using the cached version of the URL.*/ export declare function getGateway(): Promise<{
    "url": string;
}>;
/** Returns an object based on the information in Get Gateway, plus additional metadata that can help during the operation of large or sharded bots. Unlike the Get Gateway, this route should not be cached for extended periods of time as the value is not guaranteed to be the same per-call, and changes as the bot joins/leaves guilds.*/ export declare function getGatewayBot(): Promise<{
...
/** Returns the bot's application object.*/ export declare function getCurrentBotApplicationInformation(): Promise<ApplicationStructure>;
/** Returns info about the current authorization. Requires authentication with a bearer token.*/ export declare function getCurrentAuthorizationInformation(): Promise<{

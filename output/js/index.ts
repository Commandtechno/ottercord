...
export function getAchievements(applicationId: string) {
...
export function getAchievement(applicationId: string, achievementId: string) {
...
export function createAchievement(applicationId: string) {
...
export function updateAchievement(applicationId: string, achievementId: string) {
...
export function deleteAchievement(applicationId: string, achievementId: string) {
...
export function updateUserAchievement(applicationId: string, achievementId: string) {
...
export function getUserAchievements(applicationId: string) {
...
/** Updates a lobby.*/
export function updateLobby(lobbyId: string) {
...
export function updateLobbyMember(lobbyId: string, userId: string) {
...
export function createLobbySearch() {
...
export function sendLobbyData(lobbyId: string) {
...
export function getGlobalApplicationCommands(applicationId: string): Promise<Array<ApplicationCommandStructure>> {
...
export function createGlobalApplicationCommand(applicationId: string, body: toJSON<{
    /** 1-32 character name*/
    name: ApplicationCommandStructure;
    /** Localization dictionary for the name field. Values follow the same restrictions as name*/
    name_localizations?: any | null;
...
export function getGlobalApplicationCommand(applicationId: string, commandId: string): Promise<ApplicationCommandStructure> {
...
export function editGlobalApplicationCommand(applicationId: string, commandId: string, body: toJSON<Partial<{
    /** 1-32 character name*/
    name?: ApplicationCommandStructure;
    /** Localization dictionary for the name field. Values follow the same restrictions as name*/
    name_localizations?: any | null;
...
export function bulkOverwriteGlobalApplicationCommands(applicationId: string): Promise<Array<ApplicationCommandStructure>> {
...
export function getGuildApplicationCommands(applicationId: string, guildId: string): Promise<Array<ApplicationCommandStructure>> {
...
export function createGuildApplicationCommand(applicationId: string, guildId: string, body: toJSON<{
    /** 1-32 character name*/
    name: ApplicationCommandStructure;
    /** Localization dictionary for the name field. Values follow the same restrictions as name*/
    name_localizations?: any | null;
...
export function getGuildApplicationCommand(applicationId: string, guildId: string, commandId: string): Promise<ApplicationCommandStructure> {
...
export function editGuildApplicationCommand(applicationId: string, guildId: string, commandId: string, body: toJSON<Partial<{
    /** 1-32 character name*/
    name?: ApplicationCommandStructure;
    /** Localization dictionary for the name field. Values follow the same restrictions as name*/
    name_localizations?: any | null;
...
export function bulkOverwriteGuildApplicationCommands(applicationId: string, guildId: string): Promise<Array<ApplicationCommandStructure>> {
...
export function getGuildApplicationCommandPermissions(applicationId: string, guildId: string): Promise<Array<GuildApplicationCommandPermissionsStructure>> {
...
export function getApplicationCommandPermissions(applicationId: string, guildId: string, commandId: string): Promise<GuildApplicationCommandPermissionsStructure> {
...
export function editApplicationCommandPermissions(applicationId: string, guildId: string, commandId: string, body: toJSON<{
    /** the permissions for the command in the guild*/
    permissions: Array<ApplicationCommandPermissionsStructure>;
...
export function batchEditApplicationCommandPermissions(applicationId: string, guildId: string): Promise<Array<GuildApplicationCommandPermissionsStructure>> {
...
export function getOriginalInteractionResponse(applicationId: string, interactionToken: string) {
...
export function editOriginalInteractionResponse(applicationId: string, interactionToken: string, body: toJSON<Partial<{
...
export function createFollowupMessage(applicationId: string, interactionToken: string, body: toJSON<{
    /** the message contents (up to 2000 characters)*/
    content?: string;
...
export function getFollowupMessage(applicationId: string, interactionToken: string, messageId: string) {
...
export function editFollowupMessage(applicationId: string, interactionToken: string, messageId: string, body: toJSON<Partial<{
    /** the message contents (up to 2000 characters)*/
    content: string;
    /** embedded rich content*/
    embeds: Array<EmbedStructure>;
...
export function getChannelMessages(channelId: string): Promise<Array<MessageStructure>> {
...
export function getReactions(channelId: string, messageId: string, emoji: string): Promise<Array<UserStructure>> {
...
export function listPublicArchivedThreads(channelId: string): Promise<typeof ChannelTypes[keyof typeof ChannelTypes]> {
...
export function listPrivateArchivedThreads(channelId: string): Promise<typeof ChannelTypes[keyof typeof ChannelTypes]> {
...
export function listJoinedPrivateArchivedThreads(channelId: string): Promise<typeof ChannelTypes[keyof typeof ChannelTypes]> {
...
export function listGuildMembers(guildId: string): Promise<Array<GuildMemberStructure>> {
    return fetch({ method: "GET", path: "/guilds".concat(guildId).concat("/members"), headers: { Authorization: getAuth() } });
}
/** Returns a list of guild member objects whose username or nickname starts with a provided string.*/
export function searchGuildMembers(guildId: string): Promise<Array<GuildMemberStructure>> {
...
export function listScheduledEventsForGuild(guildId: string): Promise<Array<GuildScheduledEventStructure>> {
...
export function getGuildScheduledEvent(guildId: string, guildScheduledEventId: string): Promise<GuildScheduledEventStructure> {
...
export function getGuildScheduledEventUsers(guildId: string, guildScheduledEventId: string): Promise<Array<GuildScheduledEventUserStructure>> {
...
export function getCurrentUserGuilds(): Promise<Array<Partial<GuildStructure>>> {
...
export function getWebhookMessage(webhookId: string, webhookToken: string, messageId: string) {
